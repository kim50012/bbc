...
<style>
	...
	.header-img-div{width:80px;height:80px;margin-right:10px;margin-left:8px;display: inline-block;}
	.header-img-div a img{border: 0 solid #ededed;width:80px;height:80px;}
	...
	.header-text-div .title-blog .span-first-one{word-break:break-word;text-overflow: -o-ellipsis-lastline; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;}
</style>
...
$(window).scroll(function () {
    ...
    if (scrollTop + windowHeight == scrollHeight) {
    	...
    	$.ajax({
    		...
    		type : "GET",
    		cache : false,
    		url : "/front/customer/getNextLikeList.htm", //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
    			...
    			if(data.list.length!=0){
    				for(var i=0;i<data.list.length;i++){
    					...
    					var htm='<div class="blog-div-show"><table style="width:100%;position: relative;"><tr style="width:100%;position: relative;"><td style="width:100px;vertical-align: top;">'+
		    					...
		    					'<p class="title-blog" onclick=\'window.location.href="/front/magazine/magazineDetail.htm?shopId='+list[i].SHOP_ID+'&magazineId='+list[i].BLOG_ID+'"\'><span class="span-first-one"><span style="color:#313131;">标题：</span>'+list[i].BLOG_TITLE +'</span></p>'+
...
<body  class="bodyColorBlogList">
	<div class="preview-out-div">
		<div class="listMsg">
			共有 <span id="spnTotalCount"> ${requestScope.newsList[0].TOTAL_CNT } </span> 条点赞
