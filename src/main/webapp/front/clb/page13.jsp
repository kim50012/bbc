		              ...
		              <div class="table">
		                <table class="table-col2 open" id="table1" cellspacing="0" cellpadding="2" width="100%" border="1">
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left" style="color:red;">회비 지출 내역</td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
								...
								<input type="hidden" name="txtLevel1" id="txtLevel1" value="교류전비용" />
		                    </td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="교류전비용"  checked="checked"/>
		  	                        <span class="Rdefine">교류전비용</span>
		                          </label>
		                        </div>
		                    </td>
		                  </tr>
...
function deleteFee(ID) {
	...
	if ("${loginMbrSq}" != "20" && "${loginMbrSq}" != "24" && "${loginMbrSq}" != "866866") {
