		                ...
		                <table class="table-col2 open" id="table1" cellspacing="0" cellpadding="2" width="100%" border="1">
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
								...
								<input type="hidden" name="txtLevel1" id="txtLevel1" value="가입비" />
		                    </td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="일반회원"  checked="checked"/>
		  	                        <span class="Rdefine">일반회원</span>
		                          </label>
		                        </div>
		                        <div class="trans">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="학생"/>
		  	                        <span class="Rdefine">학생</span>
		                          </label>
		                        </div>
		                    </td>
		                  </tr>
