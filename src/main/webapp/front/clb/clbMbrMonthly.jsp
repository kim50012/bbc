		...
		<div class="content">
			<div class="scroll-wrap refresh-wrap" id="appMbrMonthly">
				<div class="container mt10">
					<div class="title2">
						<span class="font24 bold">${amsClb.MBR_NM}님의 민턴 일기</span>
					</div>
					...
					<div id="tableWrap">
						...
						<div class="table">
							<table class="drag-table" id="table1" cellspacing="0"
	...
	<script type="text/javascript" charset="utf-8">
		...
		date.prototype = {
			...
			Draw : function() {
				...
				con.innerHTML = "<span onclick='showTr();'>" + this.Year + "년" + this.Month + "월 (${amsClb.MONTH_BBC})"
						+ "</span>";
		...
		function lBtnClick(date) {
			...
			window.location.href='/front/bbc/clb/clbMbrMonthly.htm?intClbsq=${intClbsq}&intMbrsq=${intMbrsq}&datFrdt='+gYear+'-'+gMonth;
		}
