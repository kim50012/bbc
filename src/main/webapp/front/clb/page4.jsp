		                ...
		                <table class="table-col2 open" id="table1" cellspacing="0" cellpadding="2" width="100%" border="1">
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
								...
								<input type="hidden" name="txtLevel1" id="txtLevel1" value="회비" />
		                    </td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="월회비"  checked="checked"/>
		  	                        <span class="Rdefine">월회비</span>
		                          </label>
		                        </div>
		                        <div class="trans">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="6개월회비"/>
		  	                        <span class="Rdefine">6개월회비</span>
		                          </label>
		                        </div>
		                        <p><br></p>
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="임원진할인"/>
		  	                        <span class="Rdefine">임원진할인</span>
		                          </label>
		                        </div>
		                        <div class="trans">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="가족할인"/>
		  	                        <span class="Rdefine">가족할인</span>
		                          </label>
		                        </div>
		                        <p><br></p>
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="학생할인"/>
		  	                        <span class="Rdefine">학생할인</span>
		                          </label>
		                        </div>
		                        <div class="trans">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="정회원유지"/>
		  	                        <span class="Rdefine">정회원유지</span>
		                          </label>
		                        </div>
		                        <p><br></p>
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="일일회비"/>
		  	                        <span class="Rdefine">일일회비</span>
		                          </label>
		                        </div>
		                    </td>
		                  </tr>
