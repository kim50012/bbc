...
<html>
	...
	<body>
			<div class="content">
				<div class="fixed" style="top: 0;">
					<div class="module">
						...
						<div class="list68 flex">
							<p class="flex1 switch-btn switch-btn1 active"><span>전체조별</span></p>
							<p><div class="parting-line"></div></p>
							<p class="flex1 switch-btn switch-btn2"><span>남자조별</span></p>
							<p><div class="parting-line"></div></p>
							<p class="flex1 switch-btn switch-btn3"><span>여자조별</span></p>
							<c:if test="${amsClb.CLB_GD == 'A' or amsClb.CLB_GD == 'B'}">
								<p><div class="parting-line"></div></p>
								<p class="flex1 switch-btn switch-btn4"><span>${label.排名查询}</span></p>
							</c:if>
						</div>
				...
				<div class="modules" id="rankA" style="padding-top:1rem;diaplay:block;">
