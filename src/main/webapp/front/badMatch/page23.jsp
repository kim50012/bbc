...
<script>
wechatShareMsg = "북경 한인 배드민턴 연합회에 가입하세요.";
</script>
</head>
        ...
        <div class="container f-column" style="padding-top: 0.32rem; height: 100%;">
          ...
          <div class="scroll-wrap f-col">
            ...
            <div class="contentList2 pb16" id="jump1">
              <div class="title1">
                <div>
                  <img src="/front/bbc/badMatch/img/title.jpg" style="width: 100%;"/>
                </div>
              </div>
		 ...
		 $.ajax({
				...
				success : function(data) {
					...
					if (statusFlag == 'FAIL') {
						...
						messageBox({
							title : '알림',
							message : data.list[0].MBR_NM + '님은 이미 가입되어 있습니다.',
							type : 'alert',
							callback : function() {}
						});
					...
					sendMsgCommonFunc(
							...
							, "keyword2", "북경 한인 연합회 회원 신규가입"
							, "keyword3", data.list[0].DT
							, "remark", "북경 한인 연합회 신규회원 가입이 되었습니다."
							, null, null
							, null, null
							, "ZS6ABGZpdFwNwgvNVXD-YuF3fS8ByNtUufhFSWsbNaU"
							, "orfEm0_ytIhHG9DajyYhD500MCtk"
							, "/front/bbc/clb/clbMbrList.htm?intClbsq=11"
					);
					sendMsgCommonFunc(
							"first", "신규 회원 가입 통지"
							, "keyword1", data.list[0].MBR_NM + "(" + para2 +")"
					...
					sendMsgCommonFunc(
							...
							, null, null
							, "ZS6ABGZpdFwNwgvNVXD-YuF3fS8ByNtUufhFSWsbNaU"
							, "orfEm0_SzKfFxiBWx-NBA1IWa050"
							, "/front/bbc/clb/clbMbrList.htm?intClbsq=11"
					);
					
					messageBox({
						title : '알림',
						message : "연합회 담당자 승인 대기중 입니다. 승인 후 시스템 사용이 가능합니다.",
						type : 'alert',
						callback : function() {
							window.location.href="/front/bbc/clb/clbDetMy.htm?intClbsq=11";
						}
					});
				},
