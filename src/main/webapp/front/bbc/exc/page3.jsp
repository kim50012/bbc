...
// 									;
									...
									if (feeDt != data.list[i].RDT) {
										...
										htm = ''
											...
											+ '</tr>'					
											;
										$("#table"+data.list[i].RDT).append(htm);
									}
									
									htm = ''
										+ '<tr>'
										+ '	<td style="min-width: 1rem;" onclick="modFee(\''+data.list[i].LEVEL1+'\', \''+data.list[i].FEE_SQ+'\');">'+data.list[i].LEVEL1+'</td>'
										+ '	<td style="max-width: 3.6rem;" onclick="modFee(\''+data.list[i].LEVEL1+'\', \''+data.list[i].FEE_SQ+'\');" colspan="2">'+data.list[i].LEVEL2+'<br><span style="font-weight:bold;line-height: 0.4rem;">'+data.list[i].DSC+'</span></td>'
										+ '	<td onclick="modFee(\''+data.list[i].LEVEL1+'\', \''+data.list[i].FEE_SQ+'\');" class="right" '+data.list[i].AMT_TAG+'>'+data.list[i].AMT+'</td>'
										+ '</tr>'					
										;
									$("#table"+data.list[i].RDT).append(htm);
