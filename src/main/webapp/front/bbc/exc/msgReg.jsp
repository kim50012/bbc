					...
					<div class="sub-content">
						...
						<div class="list90 bottom-dashed flex">
							...
							<div class="radio-box flex1 cen">
								<label for="r1"><input type="radio" name="strExctp"  id="r1" value="1001" />콕구매</label>
							</div>
							<div class="radio-box flex1 right">
								<label for="r2"><input type="radio"  name="strExctp"  id="r2" value="1002" />회비납부</label>
							</div>
<!-- 							<div class="radio-box flex1 right"> -->
<!-- 								<label for="r3"><input type="radio"  name="strExctp"  id="r3" value="1003" />건의사항</label> -->
<!-- 							</div> -->
						</div>
						<!--
						<div class="list90 bottom-dashed flex">
...
<%-- 								<input class="right" type="text" id="strExcdct" value="" placeholder="${label.请输入}"/> --%>
								<textarea class="textboxcontent" id="strExcdct" placeholder="请输入" style="width:95%;height:1.5rem;padding:0px;padding-top:0.34rem;padding-bottom:0.14rem;text-align:left;"></textarea>
							</div>
						</div>
				...
				<div style="text-align: center;margin-top: 0.2rem;">
					<button class="btn-submit" id="btnsubmitExcReg" onclick="window.location='/front/bbc/exc/msgDoList.htm';" style="background-color: #c0c0c0;">${label.取消}</button>
				</div>
			</div>
...
//      			 	 			,strExctit : strExctit
     					...
     					success : function(data) {
     						...
     						if(data.ret=="success"){
     		     				alert("${label.保存成功了}");
     							window.location.href="/front/bbc/exc/msgDoList.htm?intClbsq="+intClbsq;
     						}else{
     							loadingHide();
     		     				alert("${label.失败了}");
     						}
