		                ...
		                <table class="table-col2 open" id="table1" cellspacing="0" cellpadding="2" width="100%" border="1">
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
								...
								<input type="hidden" name="txtLevel1" id="txtLevel1" value="기타" />
		                    </td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="교류전참가비"  checked="checked"/>
		  	                        <span class="Rdefine">교류전참가비</span>
		                          </label>
		                        </div>
		                        <div class="trans">
		                        	<label class="radio">
