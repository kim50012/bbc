				...
				.ajax({
					...
					success : function(data) {
						...
						if (data.list.length != 0) {
							...
							htmTitle = ''
								+ '<tr>'
								+ '	<th class="noWrapCell">월</th>'
								+ '	<th class="noWrapCell">수입</th>'
								+ '	<th class="noWrapCell">지출</th>'
								+ '	<th class="noWrapCell">합계</th>'
								+ '</tr>'
								;
...
// 									;
									htm = ''
										+ '<tr>'
										+ '	<td class="center" style="font-weight:bold;background: rgb(255, 246, 246);">회비잔액</td>'
										+ '	<td class="right" style="font-weight:bold;color:blue;background: rgb(255, 246, 246);">'+data.list[i].AMTP+'</td>'
										+ '	<td class="right" style="font-weight:bold;color:red;background: rgb(255, 246, 246);">'+data.list[i].AMTM+'</td>'
										+ '	<td class="right" style="font-weight:bold;background: rgb(255, 246, 246);">'+data.list[i].AMT+'</td>'
										+ '</tr>'					
										;
								}
								else {
									...
									htm = ''
										+ '<tr>'
										+ '	<td class="center">'+data.list[i].MM+'</td>'
										+ '	<td class="right" style="color:blue;">'+data.list[i].AMTP+'</td>'
										+ '	<td class="right" style="color:red;">'+data.list[i].AMTM+'</td>'
										+ '	<td class="right">'+data.list[i].AMT+'</td>'
										+ '</tr>'					
										;
								}
								$("#table1").append(htm);
