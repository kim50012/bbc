		                ...
		                <table class="table-col2 open" id="table1" cellspacing="0" cellpadding="2" width="100%" border="1">
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
								...
								<input type="hidden" name="txtLevel1" id="txtLevel1" value="유니폼비용" />
		                    </td>
		                  </tr>
		                  ...
		                  <tr class="getWord">
		                    ...
		                    <td class="left">
		                        <div class="such mr20">
		                        	<label class="radio">
		  	                        <input class="" type="radio" name="txtLevel2" value="유니폼비용"  checked="checked"/>
		  	                        <span class="Rdefine">유니폼비용</span>
		                          </label>
		                        </div>
		                    </td>
		                  </tr>
