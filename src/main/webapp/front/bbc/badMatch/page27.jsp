  ...
  <body>
    ...
    <div class="app pop-page">
      ...
      <div class="content" style="overflow: scroll;">
        <div class="container" style="padding-top: 0.32rem; min-height: 100%;display: flex;flex-flow: row wrap;" id="gameTable1">
				...
				success : function(data) {
					...
					if (data.list.length != 0) {
						...
						for (var i = 0; i < data.list.length; i++) {
							...
							if (tag != thisTag) {
								htm = ''
									+ '<div class="scroll-wrap f-col gameTable">'
									+ '<div class="title2" style="text-align:center;display: list-item;background-color: #dbeaf1;">'
							...
							htm = ''
								+ '			<tr>'
								+ '				<td class="center" style="'+tagBack+'">'+data.list[i].COURT+'<br>'+data.list[i].START_TM+'</td>'
								+ '				<td class="center" style="'+tagBack+'">'+data.list[i].MBR_NM_A_A+'<br>'+data.list[i].MBR_NM_B_A+'</td>'
								+ '				<td class="center" style="'+tagBack+'">'+winFlgA+'</td>'
								+ '				<td class="center" style="'+tagBack+'">'+winFlgB+'</td>'
								+ '				<td class="center" style="'+tagBack+'">'+data.list[i].MBR_NM_A_B+'<br>'+data.list[i].MBR_NM_B_B+'</td>'
								+ '				<td class="center" style="'+tagBack+'" onclick="gameResult('+data.list[i].MCH_REQ_A+', '+data.list[i].MCH_REQ_B+', '+data.list[i].FINAL_GAME_LAYOUT+', '+data.list[i].NEXT_SEQ+', '+scoreaa+', '+scorebb+');">'+tagBtn+gameEndTag+'</td>'
								+ '			</tr>'
								;
								$("#tbodyList-"+thisTag).append(htm);
					...
					if (autoRefresh) {
						setTimeout(function(){ getData(true); }, 10000);
					}
				},
