...
<script>
					...
					if (data.list.length != 0) {
						...
						for (var i = 0; i < data.list.length; i++) {
							...
							htm = ''
								...
								+ '				<td class="center">'
								+ '<select id="selGamePosition'+data.list[i].MCH_REQ+'">'
								+ '<option value="2-1">2팀1위</option>'
								+ '<option value="2-2">2팀2위</option>'
								+ '<option value="4-1">4팀1위</option>'
								+ '<option value="4-3">4팀2위</option>'
								+ '<option value="4-4">4팀3위</option>'
								+ '<option value="4-2">4팀4위</option>'
								+ '<option value="3-1">3팀1위</option>'
								+ '<option value="3-2">3팀2위</option>'
								+ '<option value="3-3">3팀3위</option>'
								+ '<option value="8-1">8팀1위</option>'
								+ '<option value="8-3">8팀2위</option>'
								+ '<option value="8-5">8팀3위</option>'
								+ '<option value="8-7">8팀4위</option>'
								+ '<option value="8-8">8팀5위</option>'
								+ '<option value="8-6">8팀6위</option>'
								+ '<option value="8-4">8팀7위</option>'
								+ '<option value="8-2">8팀8위</option>'
								+ '</select>'
								+'</td>'
								...
								$("#selGamePosition"+data.list[i].MCH_REQ).val(data.list[i].STS_TP+"-"+data.list[i].STS);
								console.log("#selGamePosition"+data.list[i].MCH_REQ);
								console.log(data.list[i].STS_TP+"-"+data.list[i].STS);
	...
	function gotoFinalTeam(para3, para4) {
		...
		var gamePosition = $("#selGamePosition"+para3).val();
		var stsTp = gamePosition.split("-")[0];
		var sts = gamePosition.split("-")[1];
