...
<header>
	...
	<!-- 					<img alt="" src="/front/skin/main/img/search.png" class="header_search" onclick="doSearch('','')" /> -->
						<a onclick="doSearch('','')" class="btnSearch">搜&nbsp;索</a> 
					</td>
				</tr>
			</table>
		</div>
						 	...
						 	<tr>
						 		<td class="salesoff_td_padding"  style="width: 50%;">
									...
									<table>
										<tr>
											<td colspan="4">
												<span style="overflow:hidden; height: 140px; line-height: 140px;">
												<c:if test="${goodsList.GOODS_LIST_IMG_URL==null}">
													<img style="width:95%; height:auto; max-height: 140px;" src="/front/img_prd/demoComp/no_image.png" alt="" 
														onclick="fn_windowOpen('/front/detail/detail.htm?shopId=${goodsList.SHOP_ID}&displayId=${goodsList.DISPLAY_ID}&goodsId=${goodsList.GOODS_ID}')"/>
												</c:if>
												<c:if test="${goodsList.GOODS_LIST_IMG_URL !=null}">
													<img style="width:95%; height:auto; max-height: 140px;" src="${goodsList.GOODS_LIST_IMG_URL }" alt="" 
														onclick="fn_windowOpen('/front/detail/detail.htm?shopId=${goodsList.SHOP_ID}&displayId=${goodsList.DISPLAY_ID}&goodsId=${goodsList.GOODS_ID}')"/>
												</c:if>
												</span>
											</td>
							...
							<c:if test="${status.index%2==1}">
								<td class="salesoff_td_padding" style="width: 50%;">
									...
									<table>
										...
										<tr>
											<td colspan="4">
												<span class="headtitle">${goodsList.DESC_TITLE }</span>
											</td>
										</tr>
										<tr>
											<td colspan="2">
