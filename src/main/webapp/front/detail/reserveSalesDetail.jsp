...
$(function(){
	...
	$(".productAttribute.spec2 li").click(function(){
		...
		$("#span_price_flag").show();
 		...
 		//priceOptionId=optionId;
		//priceUnitSales=unitSales;
		$('#hiddenPriceOptionId').val(optionId);s
 		$('#hiddenPriceUnitSales').val(unitSales);
	...
	<div id="container">
		<section id="contents">
			...
			<table class="goodsDetailDescTable">
				<tr>
					<td colspan="2" width="40%" style="padding: 10px;" align="left">
						<div class="detail_bought_count" style="width:100%; padding-top: 3px; text-align:left;">
<%-- 							<span class="detail_desc" style="color: #000000;">${detail.SUM_PAY_QTY }人已许愿</span> --%>
						</div>
					</td>
					<td colspan="2" style="padding: 10px;" align="right">
						<span class="reserveTimerRedSpan" id="reserveEndTime${detail.DISPLAY_ID}"></span>
					</td>
				</tr>
				<tr>
...
<!-- 						</div> -->
						<div class="detail_favorite_count" style="padding-top: 3px; text-align:right; width:50%;">
							<span class="detail_desc" style="color: #000000;">已预售${detail.SUM_PAY_QTY }人</span>
						</div>
					</td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 10px; border-top: 1px solid #f0f0f0;">
			...
			<script>
				var Timer${detail.DISPLAY_ID} = new (function() {
				    var $countdown,
				        $form, // Form used to change the countdown time
				        incrementTime = 70,
				        currentTime = "${detail.RESERVE_END_TM}",
				        updateTimer = function() {
				            $countdown.html(formatTime(currentTime, 1));
				            if (currentTime == 0) {
				            	Timer${detail.DISPLAY_ID}.Timer.stop();
				                timerComplete();
				                Timer${detail.DISPLAY_ID}.resetCountdown();
				                return;
				            }
				        ...
				        timerComplete = function() {
				        	$('#reserveEndTime${detail.DISPLAY_ID}').html('已抢光');
				        	$("#ReserveBuyControlBtn").hide();
				        },
				        init = function() {
				            $countdown = $('#reserveEndTime${detail.DISPLAY_ID}');
				            Timer${detail.DISPLAY_ID}.Timer = $.timer(updateTimer, incrementTime, true);
				        };
...
<!-- 			    	</div> -->
	...
	<div class="footer length2"  id="ReserveBuyControlBtn">
