...
*/
var kkpager={pagerid:"kkpager",mode:"link",pno:1,total:1,totalRecords:0,
		isShowFirstPageBtn:true,isShowLastPageBtn:true,isShowPrePageBtn:true,
		isShowNextPageBtn:true,isShowTotalPage:true,isShowTotalRecords:false,
		isGoPage:true,hrefFormer:"",hrefLatter:"",gopageWrapId:"kkpager_gopage_wrap",
		gopageButtonId:"kkpager_btn_go",gopageTextboxId:"kkpager_btn_go_input",
		lang:{firstPageText:"\u9996\u9875",firstPageTipText:"\u9996\u9875",
			lastPageText:"\u5C3E\u9875",lastPageTipText:"\u5C3E\u9875",
			prePageText:"\u4E0A\u4E00\u9875",prePageTipText:"\u4E0A\u4E00\u9875",
			nextPageText:"\u4E0B\u4E00\u9875",nextPageTipText:"\u4E0B\u4E00\u9875",
			totalPageBeforeText:"\u5171",totalPageAfterText:"\u9875",
			totalRecordsAfterText:"\u6761\u6570\u636E",gopageBeforeText:"\u8F6C\u5230",
			gopageButtonOkText:"\u786E\u5B9A",gopageAfterText:"\u9875",
			buttonTipBeforeText:"\u7B2C",buttonTipAfterText:"\u9875"},
			getLink:function(a){if(a==1){
				return this.hrefFormer+this.hrefLatter}
			else{return this.hrefFormer+"_"+a+this.hrefLatter}},
			click:function(a){return false},getHref:function(a)
			{return"#"},focus_gopage:function(){
				var a=$("#"+this.gopageButtonId);
				$("#"+this.gopageTextboxId).attr("hideFocus",true);
				a.show();a.css("left","0px");$("#"+this.gopageWrapId).css("border-color","#6694E3");
				a.animate({left:"+=44"},50,function(){})},blur_gopage:function(){var a=this;setTimeout(function()
						{var b=$("#"+a.gopageButtonId);
						b.animate({left:"-=44"},100,function(){
							b.css("left","0px");b.hide();$("#"+a.gopageWrapId).css("border-color","#DFDFDF")})},400)},
							gopage:function(){var a=$("#"+this.gopageTextboxId).val();
							if(isNaN(a)){$("#"+this.gopageTextboxId).val(this.next);
							return}var b=parseInt(a);if(b<1){b=1}
							if (b > this.total) {
			b = this.total
		}
		if (this.mode == "click") {
