    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f8b8ac6fcf571cfe300bc86228b077ce&redirect_uri=http://kr.bbcoin.net:8080/front/bbc/mbr/userAddRequest.htm"
                ...
                <c:if test="${userInfo.MBR_SQ != '0'}">
                <a href="https://kauth.kakao.com/oauth/logout?client_id=f8b8ac6fcf571cfe300bc86228b077ce&logout_redirect_uri=http://kr.bbcoin.net:8080/front/bbcNew/getPage.htm?pageName=index"
                   class="bg-yellow-400 hover:bg-yellow-500 text-black py-2 px-4 rounded-lg transition duration-300 flex items-center font-semibold">
                    로그 아웃
                </a>
				</c:if>
        ...
        <section class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20 md:py-28">
            <div class="container mx-auto px-6 text-center">
                ...
                <div class="space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#club-directory" class="inline-block bg-white text-indigo-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg shadow-md transition duration-300 text-lg w-full sm:w-auto">
                        동호회 둘러보기
                    </a>
                    <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f8b8ac6fcf571cfe300bc86228b077ce&redirect_uri=http://kr.bbcoin.net:8080/front/bbc/mbr/userAddRequest.htm" class="inline-block bg-yellow-400 text-gray-900 hover:bg-yellow-300 font-semibold py-3 px-8 rounded-lg shadow-md transition duration-300 text-lg w-full sm:w-auto">
                        카카오톡 로그인
                    </a>
                </div>
            </div>
