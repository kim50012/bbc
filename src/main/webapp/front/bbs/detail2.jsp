...
//  	   				$("#detail_message"+bbsId).attr("src","/front/skin/nongshim/img/icon_mess1.png");
 	   				alert("评论成功");
 	   				window.location.href='/front/bbs/detail2.htm?bbsId=${detail.BBS_ID}&shopId=${sessionScope.sessionSkin.shopId}'
 	   			}else{
...
function share(){
	...
	var param={
   	...
   	$.ajax({
   		...
   		type : "GET",
   		cache : false,
   		url : "/front/bbs/bbsShareInsert.htm", 
   		contentType : "application/x-www-form-urlencoded; charset=UTF-8", 
   		success : function(data){
//    			alert(bbsId);
	...
	if('${loginFlag}'=='0'){
		...
		var param={
	   	...
	   	$.ajax({
	   		...
	   		type : "GET",
	   		cache : false,
	   		url : "/front/bbs/bbsLikeShareInsert.htm", //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
	   		contentType : "application/x-www-form-urlencoded; charset=UTF-8", 
	   		success : function(data){
	...
	<div id="container">
	    ...
	    <section id="contents">
			<div class="detail-div-title">
				...
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG6!=null}">
						<img alt="" src="${detail.IMG6}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG7!=null}">
						<img alt="" src="${detail.IMG7}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG8!=null}">
						<img alt="" src="${detail.IMG8}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG9!=null}">
						<img alt="" src="${detail.IMG9}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG10!=null}">
						<img alt="" src="${detail.IMG10}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG11!=null}">
						<img alt="" src="${detail.IMG11}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG12!=null}">
						<img alt="" src="${detail.IMG12}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG13!=null}">
						<img alt="" src="${detail.IMG13}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG14!=null}">
						<img alt="" src="${detail.IMG14}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG15!=null}">
						<img alt="" src="${detail.IMG15}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG16!=null}">
						<img alt="" src="${detail.IMG16}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG17!=null}">
						<img alt="" src="${detail.IMG17}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG18!=null}">
						<img alt="" src="${detail.IMG18}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG19!=null}">
						<img alt="" src="${detail.IMG19}">
					</c:if>
				</div>
				<div class="detail-div-cont" style="padding-top: 5px;">
					<c:if test="${detail.IMG20!=null}">
						<img alt="" src="${detail.IMG20}">
					</c:if>
				</div>
...
$(function(){ 
	  ...
	  wx.ready(function(){
	  		...
	  		wx.onMenuShareTimeline({
	  			title: '分享味蕾的快乐，为我点赞，一起品尝美食~', // 分享标题
