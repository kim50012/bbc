		...
		<%@include file="/publish/frontoffice/include/head_store.jsp"%>
			...
			<div id="contents">
				<div class="page-sublocation">
					<a href="#">主页</a><span>&gt;</span><a href="#">活动</a><span>&gt;</span><strong>查看 DM</strong> 
				</div> 
				...
				<h4><img src="/images/shop/cn/store/title_dmview.gif" alt="查看新世界免税店DM " /></h4> 
				<div class="table-listhtype">	
					<p class="info">共有 <strong>13</strong> 个活动。</p> 
					<div class="dmview-search">  
						<select id="table-search" title="검색범위 선택">
							<option>按最近发表日</option>
							<option>조회 순</option>
						</select>  		 
					</div>						
					<div class="list">
						<table summary="신세계면세점 DM 테이블">
							<caption>신세계면세점 DM 테이블</caption>
							<colgroup>  
								<col width="62px" /> 
								<col width="304px" />  
								<col width="165px" />  
							...
							<tbody>   
								<tr>  
									...
									<td><a href="#"><img src="/images/shop/cn/store/btn_down.gif" alt="다운로드" /></a></td> 
								</tr>    
								<tr>  
									<td><span class="fta">4</span></td>  
									<td class="subject"><a href="#">관리자 상승 오류시 해결 방법</a></td>   
									<td><span class="fta">2013-01-30 ~ 2013-02-30</span></td>
									<td><span class="fta">2013-01-30</span></td>
									<td><span class="fta">1234</span></td>
