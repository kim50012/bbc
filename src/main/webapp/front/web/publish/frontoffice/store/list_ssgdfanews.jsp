		...
		<%@include file="/publish/frontoffice/include/head_store.jsp"%>
			...
			<div id="contents">
				<div class="page-sublocation">
					<a href="#">主页</a><span>&gt;</span><a href="#"> 使用指南</a><span>&gt;</span><strong>新世界免税店介绍</strong>
				</div>  
				...
				<h4><img src="/images/shop/cn/store/title_ssgdfanews.gif" alt="新世界免税店消息" /></h4> 
