...
*/		
			...
			$("table td p.destination div").click(function(){
				$(this).css("z-index" ,"30");
			});
			$("table td div.destination-box div").click(function(){
 			...
 			$(".order-board").eq(2).css("z-index" ,"2");
 			$("h3").eq(2).css("z-index" ,"2");
...
<div id="wrapper">
	<div id="wrap">
		...
		<div id="body">
			...
			<h3><img src="/images/shop/cn/order/b_tit_m0202_01.gif" alt="订购商品" />
				<span><img src="/images/shop/cn/order/b_tit_m0202_01sub.gif" alt="请再次确认商品数量、选项信息是否正确。如需要修改，请按‘修改订购商品’按钮到购物车修改。" /></span>
			</h3>
			<div class="basket">
			...
			<h3><img src="/images/shop/cn/order/b_tit_m0202_02.gif" alt="顾客信息" />
				<span><img src="/images/shop/cn/order/b_tit_m0202_02sub.gif" alt="订购者信息必须与出境者本人一致。请务必正确填写护照信息。" /></span>
				<div class="sample-con">
					<a href="#"><img src="/images/shop/cn/order/btn_order_i05.gif" alt="sample" /></a>
					<div class="basket-layer-wrap sample" style="display:block;">
			...
			<div class="order-board">
				<table summary="订购者信息必须与出境者本人一致。请务必正确填写护照信息。">
					...
					<tbody>
						...
						<tr>
							<th scope="row"><img src="/images/shop/cn/order/sheet_tit01_3s.gif" alt="生年月日" /></th>
							...
							<th scope="row"><img src="/images/shop/cn/order/sheet_tit01_3r.gif" alt="性别" /></th>
							<td>
								<p class="gender-box">
									<input type="radio" id="man" name="gender" /><label for="man">男</label>
									<input type="radio" id="women" name="gender" /><label for="women">女</label>
								</p>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3"  class="select-container select-year02">
								<select id="passport-year" title="태어난 연도를 선택해주세요">
									<option>选择 </option>
									<option>2013</option>
									<option>2013</option>
									<option>2013</option>
								...
								<select id="passport-month" title="태어난 월을 선택해주세요">
									<option>选择 </option>
									<option>12</option>
									<option>12</option>
									<option>12</option>
								...
								<select id="passport-date" title="태어난 날짜를 선택해주세요">
									<option>选择 </option>
									<option>12</option>
									<option>12</option>
									<option>12</option>
						...
						<tr>
							<th scope="row"><img src="/images/shop/cn/order/sheet_tit01_7.gif" alt="密码" /></th>
							<td colspan="3" class="pw-box">
								<input type="password" title="password" />
								<ul class="cn-help-txt">
									<li>密码应使用4-12位的数字及英文。</li>
									<li>要想查看订购，必须输入订单号与密码。</li>
								</ul>
							</td>
						</tr>
					</tbody>
...
如信息不正确，则无法领取商品，望顾客敬请留意。" /></span>
				<span class="cn-btn-r"><a href="#"><img src="/images/shop/cn/order/btn_order_i08.gif" alt="商品领取说明+" /></a></span>
			</h3>
			...
			<div class="terms-box">
				<h3><img src="/images/shop/cn/order/b_tit_m0202_03.gif" alt="付款信息" /></h3>
					...
					<ul>
						...
						<li class="discount">
							...
							<div class="total-title"><img src="/images/shop/cn/order/total_title02.gif" alt="优惠券折扣" />
								<span class="use-money">(可使用积分 <span class="font-red">\110,405</span>)</span><p>$<span>467.0 (约 ￥413,108)</span></p>
							</div>
							...
							<dl>
								...
								<dd>
									\ <input type="text" title="포인트 조회" />									
									<p><input type="checkbox" id="now-use" name="now-use" /><label for="now-use">全部使用</label><span class="point">(拥有积分: <span class="font-red">\10,405</span>)</span></p>
									<p class="order-tip">
