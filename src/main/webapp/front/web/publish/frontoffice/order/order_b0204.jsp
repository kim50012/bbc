...
<div id="wrapper">
	<div id="wrap">
		...
		<div id="body">
			...
			<h3><img src="/images/shop/cn/order/b_tit_m0203_01.gif" alt="订购商品" /></h3>
			...
			<div class="freebie">
				<h3><img src="/images/shop/cn/order/b_tit_m0203_02.gif" alt="选择赠品" /></h3>		
				<div class="occasion">
			...
			<div class="terms-box">
				...
				<h3 class="order-title"><img src="/images/shop/cn/order/b_tit_m0203_07.gif" alt="付款信息" /></h3>
			...
			<h3><img src="/images/shop/cn/order/b_tit_m0203_07.gif" alt="付款信息" /></h3>
			...
			<div class="order-board">
				<table summary="出发地点 出国日期  航班号/直达、中转与否  目的地" >
					...
					<tbody>
						<tr>
							<th scope="row"><img src="/images/shop/cn/order/b_tit_m0203_07_1.gif" alt="选择付款方式" /></th>
			...
			<div class="agreement-box">
				<dl>
					<dt>
						<div class="tit-check"><img src="/images/shop/cn/order/b_tit_m0203_07_2.gif" alt="同意购买" /></div>

					</dt>
					<dd>
						<span class="cn-q-txt"><img src="/images/shop/cn/order/b_tit_m0203_07_2sub.gif" alt="是否已经确认了要购买的商品名、商品价格、内容及种类，并同意购买？" /></span>
