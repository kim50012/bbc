...
<div id="wrapper">
	<div id="wrap">
		...
		<div id="body">
			...
			<div class="total-price">
				<ul>
					<li class="order">
						...
						<p class="order-price"><span class="dollar">$4,498</span><span>(￦58,054,403)</span><img src="//image.ssgdfs.com/images/shop/order/minus.gif" alt="minus" /></p>
					</li>
					<li class="discount">
						<p class="tit"><img src="//image.ssgdfs.com/images/shop/order/head_cell_tit02.gif" alt="할인/적립금사용금액" /></p>
						<p class="discount-price"><span class="dollar">$745.4</span><span>(￦49,513,108)</span></p>
					...
					<li class="payment">
						<p class="tit"><img src="//image.ssgdfs.com/images/shop/order/head_cell_tit03.gif" alt="최종 결제금액" /></p>
						<p class="payment-price">
							<span class="ori">$4,031</span><span>(￦40,513,108)</span><img src="//image.ssgdfs.com/images/shop/order/equal.gif" alt="equal" class="equal" /></p>
						<div class="final-payment">
							<dl>
								<dt><img src="//image.ssgdfs.com/images/shop/order/limit.gif" alt="면세한도" /></dt>
								<dd>$1,832</dd>
								<dt><img src="//image.ssgdfs.com/images/shop/order/apply.gif" alt="적용금액" /></dt>
								<dd>(￦4,513,108)</dd>
							</dl>
						</div>
					</li>
			...
			<h3><img src="//image.ssgdfs.com/images/shop/order/h3_payment_option.gif" alt="결제수단" /></h3>
			<div class="order-board bor-top">
				<table summary="결제를 위한 고객 정보 확인 게시판">
					<caption>고객 정보 확인</caption>
					<colgroup>
