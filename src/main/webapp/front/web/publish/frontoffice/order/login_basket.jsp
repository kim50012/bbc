...
<div id="wrapper">
	<div id="wrap">
		...
		<div id="body">
			...
			<h3><img src="//image.ssgdfs.com/images/shop/order/h3_basket_in.gif" alt="加入购物车的商品" /></h3>
			<div class="basket">
				<table summary="加入购物车的商品">
					<caption>加入购物车的商品</caption>
					<colgroup>
						<col width="58px" />
						<col width="101px" />
						<col width="340px" />
					...
					<thead>
 					...
 					<tbody>
						<tr>
												...
												<table summary="상품옵션 재설정 서식">
													...
													<thead>
														<tr>
															...
															<th scope="col"><img src="//image.ssgdfs.com/images/shop/order/th_choice_option.gif" alt="option_choice" /></th>
														</tr>
													</thead>
													<tbody>
														<tr>
							...
							<td>
								<ul>
									<li><a href="#"><img src="/images/shop/cn/order/btn_buy_no.gif" alt="不可订购" /></a></li><!-- 주문불가 버튼 -->
						...
						<tr>
							...
							<td>
								<ul>
									<li><a href="#"><img src="/images/shop/cn/order/btn_buy.gif" alt="立即购买" /></a></li><!-- 바로구매 버튼 -->
									<li><a href="#"><img src="/images/shop/cn/order/btn_wish.gif" alt="关注商品" /></a></li>
									<li><a href="#"><img src="/images/shop/cn/order/btn_dell.gif" alt="删除" /></a></li>
								</ul>
							</td>
					...
					<li class="total-product">
						<dl class="head-cell">
							...
							<dd>
								...
								<img src="/images/shop/cn/order/minus.gif" alt="-" class="minus" />
							</dd>
						</dl>
						<dl class="pattern">
							<dt>全部商品种类</dt>
