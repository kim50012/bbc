				...
				<div id="contents">  
					...
					<div class="stitle-conbox">   
						...
						<div class="table-listwtype">	 
							...
							<!-- 출국정보가 동일한 주문이 존재할 경우 해당 메시지를 노출 -->
							<p class="info-order">出境信息相同的订单共 2件 : <a href="#">6941940363932</a> <a href="#">6941940363933</a></p>			
						</div>  
					</div>
							...
							<table summary="订购商品">
								...
								<tbody>   
									<tr>  
										...
										<td>
											<p class="price"> 
												<span class="us-currency">\1,000</span>
												<span class="nation-currency">(约 $1,000)</span>
											</p>
										</td>
									</tr>   
									<tr>  
					...
					<div class="table-listwtype">	 
						<div class="list gifttable">
							<table summary="사은품정보 테이블">
								<caption>사은품정보 테이블</caption>
								<colgroup>  
									<col width="120px" />   
									<col width="270px" />   
									<col width="120px" />  
								...
								<thead>
									<tr>
										<th colspan="4">按购买金额赠送</th>
									</tr>
								</thead>
								<tbody> 
									<tr> 
										<th scope="col"><span>购买金额</span></th>
										<td><span>$300 以上</span></td>  
										<th scope="col"><span>选项</span></th>
										<td><span>新世界网上免税店积分</span></td>
									</tr>    
									<tr> 
										<th scope="col"><span>发放金额</span></th>
										<td><span>18,000韩元</span></td> 
										<th scope="col"><span>申请日</span></th>
										<td><span>2013-08-27</span></td> 
									</tr>  
								</tbody>  
							</table> 
						</div> 				
					...
					<div class="table-listhtype">	 
						<div class="list info-product">
							<table summary="订购取消明细">
                    			<caption>订购取消明细</caption>
								<colgroup>  
									<col width="119px" /> 
									<col width="462px" /> 
									<col width="61px" />  
					...
					<div class="table-listwtype">	 
						<div class="list stitle-cancel">
							<table summary="付款取消信息">
								<caption>付款取消信息</caption>
								<colgroup>  
									<col width="120px" /> 
									<col width="270px" /> 
									<col width="140px" />  
								...
								<tbody>  
									<tr> 
										...
										<td><span>YYYY.MM.DD</span></td> 
										<th scope="col"><span>处理现状/处理日期</span></th>
									...
									<tr> 
										...
										<td colspan="3" class="final"><p>$149 (约 ￥125.00),</p>
											<span>退还积分 : <strong class="f-red">\2,500 (约 $2)</strong></span></td>  
									</tr>    
								</tbody>  
							</table> 
							<div class="btn_wrap">
								<p class="right"><a href="#"><img src="/images/shop/cn/mypage/btn_orderlist_h.gif" alt="回到订购目录" /></a><a href="#"><img src="/images/shop/cn/mypage/btn_ordercancel.gif" alt="取消订购" /></a></p>
							</div>	
						</div> 									
					</div>		  
										
					<p class="stitle"><img src="/images/shop/cn/mypage/stitle_orderlist06.gif" alt="说明及注意事项  " /></p>
