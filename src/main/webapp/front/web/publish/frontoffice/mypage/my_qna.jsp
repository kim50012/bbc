			...
			<div class="mypage"> 
				...
				<div id="contents">  
					<div class="page-sublocation">  
						<a href="#">主页</a><span>&gt;</span><a href="#">我的页面</a><span>&gt;</span><a href="#">我的资讯</a><span>&gt;</span><strong>商品Q&amp;A</strong>
					</div>
			 
					<%@include file="/publish/frontoffice/include/top_mypage.jsp"%><!-- //마이페이지 공통 --> 
						 				
					<h3><img src="/images/shop/cn/mypage/title_qna.gif" alt="商品Q&amp;A" /><span><img src="/images/shop/cn/mypage/explain_inquiries.gif" alt="对于您的咨询，我们将回复内容发送至您的E-mail。请准确输入您的E-mail信息。" /></span></h3>	
					 				 
					<div class="table-listhtype">								 
						<div class="list qna">
							<table summary="商品Q&amp;A" class="qna-table">
								...
								<tbody>   
										...
										<td colspan="5">
											<div class="qna-box">
												<div class="q-box">
													...
													회원가입할 때 본인인증이 안됩니다.
													<a href="#" class="btn_de"><img src="/images/shop/cn/mypage/btn_delete.gif" alt="删除" /></a>
												</div>
									...
									<tr>
										<td class="subject"><a href="#">상품주문 관련 문의입니다.</a></td>  
										<td class="brand"><span>SCHRAMMEK</span></td> 
										<td class="model-name"><a href="#"><span>세트상품PITERDELUX SET</span></a></td> 
										<td><span class="fta">2013.05.02</span></td>
										<td class="check"><span class="check">正在准备回复</span></td>
									</tr> 
									<tr class="con"> 
