			...
			<div class="mypage"> 
				...
				<div id="contents">  
					...
					<div class="con-tab">	 
						<div class="tab-atype">
							<ul class="tab-menu"> 
								...
								<li class="selected"><a href="#">已过期优惠券(122)</a></li>
					...
					<div class="table-listhtype discount-coupon">						
						<div class="list"> 					 
							<table summary="더이상 사용이 불가능한 쿠폰 내역">
								<caption>더이상 사용이 불가능한 쿠폰 내역</caption>
								<colgroup>  
									<col width="100px" /> 
									<col width="75px" />  
									<col width="100px" /> 
								...
								<thead>
									<tr> 
										...
										<th scope="row">状态</th> 
										<th scope="row">优惠券发放日<br />(优惠券有效期)</th>  
										<th scope="row">使用条件</th>       
									</tr>
								</thead>
								<tbody>
									<tr> 
										<td><span class="coupon-id">5111380107945</span></td> 
										<td><span class="divide">购物车优惠券</span></td> 
										<td class="couponname"><span>현금쿠폰</span></td> 
										<td class="useinfo"><span>$10,000</span></td>  
										<td class="now-state">使用(2013.05.02)<span>(订购号码:<a href="#">6809314133505</a>)</span></td> 
										<td><p><span class="fta">2013.01.02</span></p><p><span class="fta">(2013.01.02)</span></p></td>   
									...
									<tr> 
										...
										<td class="now-state"><span class="check-on">已过期</span></td> 
										<td><p><span class="fta">2013.01.02</span></p><p><span class="fta">(2013.01.02)</span></p></td>    
										<td class="using"><span>购买$300 以上</span><span>可重复使用</span></td>
									</tr> 
									<tr> 
