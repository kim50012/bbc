...
<script type="text/javascript">
	jQuery(function($){
		$("div.layor-l").hide();		
		$("li.on div.layor-l").show();
		$("div.on div.layor-l").show();	
		
		$("div a").mouseover(function(){			
			$("li.on div.layor-l").hide();
			$("div.on div.layor-l").hide();	
			$(this).next().show();
					...
					<div class="stateinfo-box">
						...
						<ul>
							...
							<li class="stateinfo05 on">
								<a href="#"><img src="/images/shop/cn/mypage/popup/order_stateinfo05_on.gif" alt="正在运送" /></a>
								<div class="layor-l">
									<div class="layor-r">
										<div class="layor-c">
											<div class="layor-box">
