...
<div id="wrap">
	<div id="head">
		<h1><img src="/images/shop/cn/mypage/popup/h1_orderlist_all.gif" alt="按出境日期综合订单" /></h1>
	</div> 
	<div id="body"> 
		<div class="contents">
			<div class="prbox_scroll"> 
				...
				<div class="orderlist-conbox"> 	
					<p class="stitle"><img src="/images/shop/cn/mypage/popup/title_orderlist01.gif" alt="出境信息" /></p>
					<div class="table-listwtype">	 
						<div class="list">
							<table summary="출국 정보 테이블">
								<caption>출국 정보 테이블</caption>
								<colgroup>  
									<col width="120px" /> 
									<col width="232px" /> 
									<col width="120px" />  
					...
					<p class="stitle"><img src="/images/shop/cn/mypage/popup/title_orderlist02.gif" alt="付款信息" /></p>
					<div class="table-listhtype">	 
						<div class="list info-order">
							<table summary="주문 정보 테이블">
								...
								<thead>
									<tr> 
										...
										<th scope="row">商品合计金额</th> 
										<th scope="row">折扣金额</th>  
										<th scope="row">积分使用金额</th> 
										<th scope="row">最终付款金额</th>    
									</tr>
								</thead>
								<tbody>   
									<tr>  
										...
										<td class="useinfo">
											<p class="price"> 
												<span class="us-currency">$63.2</span>
												<span class="nation-currency">(约￥1,091,270)</span>
											</p>
										</td>
										<td class="useinfo">
											<p class="price"> 
												<span class="us-currency">$13.2</span>
												<span class="nation-currency">(约￥1,091,270)</span>
											</p>
										</td>
										<td>
								...
								<tfoot>
									<tr>
										<th colspan="2"><span>以出境日期为基准的付款合计金额</span></th>
										<td colspan="3"><span>$250,041.68 (约￥108,132,200)</span></td>
									</tr>
								</tfoot>
							</table> 
						</div> 				
							...
							<table summary="주문 상품 테이블">
								...
								<thead>
									<tr> 
										<th scope="row">订单号码</th> 
										<th scope="row">商品名</th> 
										<th scope="row">订购金额</th>  
										<th scope="row">数量</th>     
									</tr>
								</thead>
								<tbody>   
									<tr>  
										<td rowspan="2"><span class="ordernumber">6809314133505</span></td> 
										<td class="info">
									...
									<tr>  
										...
										<td class="info">
											<div class="product-info"> 
												<p class="brand">[KIEHL`S]</p> 
												<p class="product-num">(<span>REF. NO :</span> PEANU-MD.F/97)</p> 
												<p class="product">ULTRA FACIAL CREAM 125MLTAG HEUER CARRERA 125MLTAG</p> 
												<p class="option"><span class="tel">(상품문의 : 051-749-1369)</span></p>
											</div>
										</td> 
										<td>
											<p class="price"> 
