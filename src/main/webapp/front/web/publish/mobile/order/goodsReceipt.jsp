...
<body >
	...
	<form id="form1" action="/front/web/publish/mobile/order/orderConfirm.htm" method="post">
					...
					<a>
						<c:choose>
							...
							<c:otherwise>
								...
								<span class="defaultAddress"  onclick="fnSetDefaultAddress(${list.ADDRESS_ID});">기본주소지</span>
							</c:otherwise>
						</c:choose>
						<br/>
	...
	<div class="footerFixed" style="background: #f4f4f4;">
		...
		<div class="btnGroup agc" style="background: #f4f4f4;">
			<a class="btn theme1" style="background: #d41818;" href="/front/web/publish/mobile/order/addressCreate.htm?priceOptionId=${requestScope.priceOptionId}&addressIdSelected=${requestScope.addressId}&goods_qty_num=${requestScope.goods_qty_num}&shopId=${sessionSkin.shopId}">
				<img class="btnIconPlus" src="/front/skin/main/img/orderConfirm/new.png">신규 주소지 추가
			</a> 
		</div>
	</div>
		 			...
		 			$.ajax({
		 				...
		 				success : function(data) {
		 					if(data.ret == "fail"){
		 						...
		 						window.location.href = "/front/web/publish/mobile/order/goodsReceipt.htm"
