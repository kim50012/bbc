	...
	return this.each(function(){
      ...
      if(settings.debug && typeof(console) != 'undefined') {
        console.log('Img dimensions:'+imgWidth+'x'+imgHeight);
			...
			var intWidth = (imgWidth + (settings.containerBorderSize * 2)); // Plus the image탐s width and the left and right padding value
			var intHeight = (imgHeight + (settings.containerBorderSize * 2)); // Plus the image탐s height and the left and right padding value
