		...
		return this.each(function() {
			...
			imgs.each(function() {
	            ...
	            if(current_obj.currentImg.is('li')){
	            	...
	            	contentHolderUnit = ontentHolderUnit = jQuery('<div class="contentHolderUnit" rel="'+ (total_images-1) +'" id="contentHolderUnit_'+ (total_images-1) +'">'+'<span class="event-term"><span class="title-wrap"></span><span class="title">'+current_obj.currentImg.find("img").attr("title")+'</span><span class="term">'+current_obj.currentImg.find("img").attr("alt")+'</span></span>'+'<span class="total">'+(total_images)+'</span>'+current_obj.currentImg.html()+'</div>');
			...
			if (options.enableTouchScreen) {
				...
				allinone_carousel_container.css('cursor','url('+options.absUrl+'skins/hand.cur),url('+options.absUrl+'skins/hand.cur),move');
