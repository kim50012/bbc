...
/*   function getUrl(){
  ...
  function uploadImage(){
		if(gLocalIds == '' || gLocalIds.length == 0){
			return;
		}  
		
		var localId = gLocalIds.shift();
 ...
 <body>
 	<ul style="margin-top: 10px;margin-left: 5px;">
 		...
 		<li class="level1">分享接口
 			<ul> 		
 				<li><a href="javascript:void(0);" onclick="shareQQZone();">分享到QQ空间</a></li>
 				<li><a href="javascript:void(0);" onclick="shareSinaBlog();">分享到新浪微博</a></li>
 				<li><a href="javascript:void(0);" onclick="shareQQBlog();">分享到QQ微博</a></li>
 				<li><a href="javascript:void(0);" onclick="shareDouban();">分享豆瓣网</a></li>
 	  ...
 	  <li class="level1">Share信息
 			<ul> 		
 				 <li>title = ${shareInfo.title}}</li>
 				 <li>desc = ${shareInfo.desc}}</li>
 				 <li>link = ${shareInfo.link}}</li>
 				 <li>imgUrl = ${shareInfo.imgUrl}}</li>
 			</ul>
 		</li>  
	 ...
	 <a href="javascript:(function(){window.open('http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+ encodeURIComponent(location.href)+ '&title='+encodeURIComponent(document.title),'_blank');})()" title="分享到QQ空间">
	 <img src="http://filer.blogbus.com/1054487/resource_105448712747074974.png"  alt="Qzone一键分享" border="0">
	 </a>
