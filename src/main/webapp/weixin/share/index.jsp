 ...
 <body style="background-color: #eee;min-width:1000px;">
  <div id="container" >
  	...
  	<%-- <div>
  	  ...
  	  <ul>
  	  	<li>
  	  	ui:ellipsis =>  <ui:ellipsis length="3" value="12345678"></ui:ellipsis>
  	  	</li>
  	  	<li>
  	  	 ui:mask =>  <ui:mask pattern="####.##.## ##:##">20150520112211</ui:mask>
  	  	</li>
  	  	<li>
  	  	 ui:msg =>  <ui:msg num="10" info="hello world"/>
  	  	</li>
  	  	<li>
  	  	<ui:i18n key="{0},{1}" params1="郑太范" params2="上午好"/>
  	  	</li>
  	  	<li>
  	  	<c:set var="dd" value="<%=new java.util.Date() %>"></c:set>
  	  	 <ui:date value="${dd }" pattern="yyyy-yyyy-yyyy" />
  	  	 <fmt:parseDate value="2015-03-24 12:23:34" var="date" pattern="yyyy-MM-dd HH:mm:ss" />
<c:set value="2015-03-24 12:23:34" var="sdate" />
<jsp:useBean id="now" class="java.util.Date">
  <jsp:
</jsp:useBean>

${date }   ==> <ui:date value="${date }" pattern="yyyyMMddHHmmss" /> <br>
${sdate } ==> <ui:date value="${sdate }" pattern="yyyyMMddHHmmss"  /><br> 
${now } ==> <ui:date value="${now }" pattern="yyyyMMddHHmmss"  /> <br>
  	  	</li>
  	  </ul>
  	</div> --%>
 ...
 <div style="margin: 10px auto; width: 95%;">
  <div class="item">
  	...
  	<textarea id="weixiUrl"  rows="4" style="width:99%;font-size: 15px; resize: none;"></textarea>
