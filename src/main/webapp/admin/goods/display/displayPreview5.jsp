				...
				<tr>
					<td colspan="4" style="padding-top: 8px;padding-left: 8px;">
						...
						<div class="detail_bought_count" style="padding-top: 3px;">
							<span class="detail_desc"><c:if test="${empty(goodsDispalyPriceInsert.sumPayQty) or goodsDispalyPriceInsert.sumPayQty == ''}">0</c:if>${goodsDispalyPriceInsert.sumPayQty }人付款</span>
						</div>
						<div class="detail_favorite_count" style="padding-top: 3px;">
							...
							<input type="text" value="${goodsDispalyPriceInsert.sumFvortQty }"/>
						</div>
					</td>
				</tr>
				<tr>
