...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#logoUploadImg').attr('src','${requestScope.goodsImgUrl}');
		$('input[name="goodsWeight"]').val("${requestScope.goodsWeight}");
		goodsImg = "${requestScope.goodsImgUrl}";
	...
	function save(){
		...
		//alert("goodsNm="+goodsNm+"|||"+"goodsId="+goodsId+"|||"+"goodsClass2="+goodsClass2+"|||"+"goodsClass3="+goodsClass3+"|||"+"isReal="+isReal);
		//return;
...
<body>
								...
								<div class="scroll">
									<ol>
										<c:forEach items="${requestScope.oneSelectList}" var="items" varStatus="status">
											<li onclick="javascript:selectChange('${items.goodsClassId}','${items.goodsClassNm}','1');" class="<c:if test="${requestScope.oneSelectNm eq items.goodsClassNm}">active</c:if>"><span>${items.goodsClassNm}<span><span class="ui-list-item-arrow">></span></li>
										</c:forEach>
									</ol>
								</div>
							</div>
								...
								<div class="scroll">
									<ol class="liListTwo">
										<c:forEach items="${requestScope.twoSelectList}" var="items" varStatus="status">
											<li class="<c:if test="${requestScope.twoSelectNm eq items.goodsClassNm}">active</c:if>"><span>${items.goodsClassNm}<span><span class="ui-list-item-arrow">></span></li>
										</c:forEach>
									</ol>
								</div>
							</div>
								...
								<div class="scroll">
									<ol class="liListThree">
										<c:forEach items="${requestScope.threeSelectList}" var="items" varStatus="status">
											<li class="<c:if test="${requestScope.threeSelectNm eq items.goodsClassNm}">active</c:if>"><span>${items.goodsClassNm}<span><span class="ui-list-item-arrow">></span></li>
										</c:forEach>
									</ol>
								</div>
							</div>
					...
					<div class="form-group clearfix">
						...
						<div class="control-group-img">
							...
							<div class="form-control">
								...
								<div id="preview">
									<img id="logoUploadImg" src="/admin/images/shopCreate/upload120.png" />
								</div>
	...
	<!-- ▼ Popup -->
	<div class="divPopup" tabindex="-1" role="dialog" aria-labelledby="modal_header_02_label" aria-hidden="true">
