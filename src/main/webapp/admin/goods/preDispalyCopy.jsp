...
<title>${label.商品发布}::${label.重复发布页面}</title>  
			  				...
			  				<div class="ui-gridarea clearfix" style="min-height: 250px;">
								<table class="grid">
									...
									<tfoot data-target="#btnSerachGrid" id="js-result-grid-footer">
									 <!-- 
									 <img alt="" src="/admin/images/icon/page-first.png" />
									 <img alt="" src="/admin/images/icon/page-preview.png" />
									 <img alt="" src="/admin/images/icon/page-next.png" />
									 <img alt="" src="/admin/images/icon/page-last.png" />
									  -->
								        <tr>
							...
							<table id="goods-stock" class="table goods-stock" style="width: 500px; ">
								...
								<tbody> 
									...
									<tr>
										...
										<td><input type="text" name="sku_price" class="js-price"	 data-id="${items.ROWID}" data-price-option-id="${items.PRICE_OPTION_ID }" data-type="price" data-name="${label.原价}" value="<ui:money  value="${items.PRICE_ORG }" />"  style="width: 50px;text-align:center;" ></td>
										<td><input type="text" name="sku_price" class="js-unit"	 	 data-id="${items.ROWID}" data-price-option-id="${items.PRICE_OPTION_ID }" data-type="unit" data-name="${label.单价}" value="<ui:money  value="${items.PRICE_UNIT_SALES }" />"  style="width: 50px;text-align:center;" ></td>
										<td><input type="text" name="stock_num" class="js-stock-num" data-id="${items.ROWID}" data-price-option-id="${items.PRICE_OPTION_ID }" data-type="stock" data-name="${label.库存}" value="${items.STOCK_NOW }"  style="width: 50px;text-align:center;" ></td>  
									</tr>
									</c:forEach>
												...
												<div class="app-preview">
										    		<div class="app-header"></div>
										        		...
										        		<div class="app-config">
										            		<div id="app-field-header" class="app-field" style="cursor: default;" data-field-type="header" data-field-item2='${slideImgsJson }' >
										                		<h1><span></span></h1>
...
$(function(){
	   $('.ui-sortable').sortable({ axis: "y"});  
	    ...
	    $('.js-btn-load').click(function(){
	      ...
	      $.ajax({
				url : "/admin/goods/displayCopy.htm",
				type : "POST",
