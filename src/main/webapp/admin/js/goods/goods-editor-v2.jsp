	...
	if(item.length > 0){
	 ...
	 $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 462, 
				action : '/admin/master/file/picture.htm?fileGroup=1&conformMethod=fnChooseHeadSlider&clsoeMethod=fnCloseHeadSlider' //参数 fileGroup 必选 1：商品   2：素材    3：Blog
	 ...
	 // initHeaderSlider(item);
	  ...
	  $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 462, 
				action : '/admin/master/file/picture.htm?fileGroup=1&conformMethod=fnChooseType01&clsoeMethod=fnClosePicture' 
			});	
		 });
	...
	var item = $editing.data('fieldItem') || [] ;
	  ...
	  $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 462, 
				action : '/admin/master/file/picture.htm?fileGroup=1&max=1&conformMethod=fnChooseType12&clsoeMethod=fnClosePicture' 
			});	
		 });
	...
	var item = $editing.data('fieldItem') || [] ;
	  ...
	  $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 462, 
				action : '/admin/master/file/picture.htm?fileGroup=1&max=3&conformMethod=fnChooseType13&clsoeMethod=fnClosePicture' 
			});	
		 });
	...
	var item = $editing.data('fieldItem') || [] ;
	  ...
	  $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 462, 
				action : '/admin/master/file/picture.htm?fileGroup=1&max=3&conformMethod=fnChooseType18&clsoeMethod=fnClosePicture' 
			});	
		 });
	  ...
	  $editing.find('.control-group ul')
	   ...
	   $('.js-add-pic').unbind('click').click(function(){
			showIframeBpopupWindow({
				...
				width : 840, 
				height : 482, 
				action: '/admin/master/file/linkImage.htm?serachLinkType=3&max=4&conformMethod=fnChooseType52&clsoeMethod=fnClosePicture'
...
function fnChooseType52(imageArray){
	console.log("========fnChooseType52()===========");
	var $editing = $('.app-field.editing')
