     ...
     // alert($this.attr('data-field-type') + ',' + e.data.type);
     	if(type == 'header'){
    	  ...
    	  $('.js-add-goods').click(function(){
    		  showBpopupWindow({
   			   id:'bpopup',
   			   action: '/admin/materialManage/showImageWindow.htm?fileGroup=3&type=3'
   		   }); 
   	   ...
   	   $('.app-sidebar').html(template('tpl_sidebar_01', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			 showBpopupWindow({
		  			id:'bpopup',
		  			action: '/admin/materialManage/showImageWindow.htm?fileGroup=3&type=4'
		  		}); 
   		...
   		$('.app-sidebar').html(template('tpl_sidebar_12', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/materialManage/showImageWindow.htm?fileGroup=3&type=5'
	  		});
   	   ...
   	   data.item = JSON.parse(item);
   		$('.app-sidebar').html(template('tpl_sidebar_13', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			...
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/materialManage/showImageWindow.htm?fileGroup=3&type=6'
	  		});/*
   	   ...
   	   var item = $this.attr('data-field-item') || '[]';
   		...
   		$('.app-sidebar').html(template('tpl_sidebar_18', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/materialManage/showImageWindow.htm?fileGroup=3&type=7'
	  		});
   ...
   $(function(){
	   ...
	   $('.js-new-field').click(function(){
	    ...
	    $("#fileupload").fileupload({
	        ...
	        formData:{imageType : 3, imageName: '中国' },//如果需要额外添加参数可以在这里添加
	        done:function(e,res){
