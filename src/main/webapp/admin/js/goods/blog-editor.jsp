 ...
 //显示编辑器功能
     ...
     // alert($this.attr('data-field-type') + ',' + e.data.type);
     	if(type == 'header'){
    	  ...
    	  $('.js-add-goods').click(function(){
    		  showBpopupWindow({
   			   id:'bpopup',
   			   action: '/admin/weixin/material/showImageWindow.htm?fileGroup=3&type=3'
   		   }); 
   	   ...
   	   $('.app-sidebar').html(template('tpl_sidebar_01', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			 showBpopupWindow({
		  			id:'bpopup',
		  			action: '/admin/weixin/material/showImageWindow.htm?fileGroup=3&type=4'
		  		}); 
   		...
   		$('.app-sidebar').html(template('tpl_sidebar_12', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/weixin/material/showImageWindow.htm?fileGroup=3&type=5'
	  		});
   	   ...
   	   data.item = JSON.parse(item);
   		$('.app-sidebar').html(template('tpl_sidebar_13', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			...
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/weixin/material/showImageWindow.htm?fileGroup=3&type=6'
	  		});/*
   	   ...
   	   var item = $this.attr('data-field-item') || '[]';
   		...
   		$('.app-sidebar').html(template('tpl_sidebar_18', data));
   		  ...
   		  $('.js-add-goods').click(function(){
   			showBpopupWindow({
	  			id:'bpopup',
	  			action: '/admin/weixin/material/showImageWindow.htm?fileGroup=3&type=7'
	  		});
   ...
   $(function(){
	   ...
	   $('.js-new-field').click(function(){
		  ...
		  if(dataFieldType == 'type-01'){//图片滚动
			  paramObj = {
				      type :dataFieldType,
				      item : []
				 };
			  tpl = template('tpl_type_01',paramObj);
		  }else if(dataFieldType == 'type-05'){//商品列表
			  paramObj = {
				      type :dataFieldType ,
				  	  size: 1 ,
				  	  goods_number_type:0
		  ...
		  }else if(dataFieldType == 'type-06'){//商品列表
			  paramObj = {
				      type :dataFieldType ,
				  	  size: 1 ,
				  	  goods_number_type:0
				 };
			  tpl = template('tpl_type_06',paramObj);
		  }else if(dataFieldType == 'type-12'){//1张图
			  paramObj = {
				      type :dataFieldType,
				      item : []
				 };
			  tpl = template('tpl_type_12',paramObj);
		  }else if(dataFieldType == 'type-13'){//2张图
			  paramObj = {
				      type :dataFieldType,
				      item : []
				 };
			  tpl = template('tpl_type_13',paramObj);
		  }else if(dataFieldType == 'type-18'){//3张图
			  paramObj = {
				      type :dataFieldType ,
				      item : []
				 };
			  tpl = template('tpl_type_18',paramObj);
		  }else if(dataFieldType == 'type-20'){//标题栏
			  paramObj = {
				      type :dataFieldType
				 };
			  tpl = template('tpl_type_20',paramObj);
		  }else if(dataFieldType == 'type-99'){//富文本
			  paramObj = {
				      type :dataFieldType
				 };
	    ...
	    $("#fileupload").fileupload({
	        ...
	        formData:{fileGroup : 3, imageName: '中国' },//如果需要额外添加参数可以在这里添加
	        done:function(e,res){
