...
var audio = document.createElement('audio');
	...
	function confirm(){
		var jobType = '';
		var messageId = '${requestScope.messageId}';
		jobType = 'H';
		//存储选择顾客的方式
		...
		//存储发送方式 
// 		var sendType = 1;
		var sendType = $('input[name="custSelect"]:checked').val();
		var param = {
		...
		<table class="result-grid-table" >
      		 ...
      		 <tbody class="result-grid-tbody" style="display:none;">
      		 	 ...
      		 	 <tr>
						...
						<input type="hidden" id="sendFileType" value="${sendFileType }" />
      		 	 	</td>
      		 	 </tr>
      		 </tbody>
		</table>
		 <div style="width:100%;height:30px;"></div>
			<div class="file_type_div" style="display:none;">
				<div class="title_div">
					<div class="title_head">
						<span class="headSpan"><ui:i18n key="标题"/>：</span>
					</div>
				...
				<div class="link_div">
					<div class="link_head">
						<span class="headSpan"><ui:i18n key="链接到"/>：</span>
					</div>
					<div class="link_body">
				...
				<div class="cover_page_div">
					<div class="cover_page_head">
						<span class="headSpan"><ui:i18n key="封面"/>：</span>
					</div>
			...
			<div class="foot_div" style="display:none;">
				<div class="send_msg_div" >
					<div class="send_msg_head" style="width:121px;">
						<span><ui:i18n key="发送内容"/>：</span>
					</div>
