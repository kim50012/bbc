...
$(function(){
	...
	$('.js-trans-order-confirm').click(function(){
        ...
        var fileName1 = imgLogoPicture.substring(imgLogoPicture.lastIndexOf('\\') + 1, imgLogoPicture.length);
        var imgLogoPicture1 =  document.getElementById('rouletteImdFile').value;
        var fileName2 = imgLogoPicture1.substring(imgLogoPicture1.lastIndexOf('\\') + 1, imgLogoPicture1.length);
		...
		$.ajaxFileUpload ({
			...
			success : function (data){
				if(data.fileUrl != ''){
					...
					$.ajaxFileUpload ({
						data : param,
						url : '/admin/rouletteActivity/saveRouletteActivity.htm',   //调用AdminShopCreateAction类中的savefile()方法存储logo图片
						secureuri : false,
				...
				<table class="game-title-table">
						<tr>
							...
							<td colspan="2" class="game-input-td">
								<input type="text" value="" id="gameTitle" style="font-size:12px;"/>
							</td>
						</tr>
						<tr>
							<td class="text-title-td" ><ui:i18n key="开始时间"/><span class="must-input">*</span>：</td>
							<td colspan="2" class="game-time-input-td">
								<input type="text" value="" style="font-size:12px;margin-right:0px;" id="gameBeginDate"/>
						...
						<tr>
							...
							<td colspan="2" class="game-time-input-td">
								<input type="text" value="" style="font-size:12px;margin-right:0px;" id="gameEndDate"/>
						...
						<tr style="height:10px;">
							...
							<td style="font-size:14px;text-align: center;position: relative;" colspan="2">
								<span style="display:inline-block;width:130px;right:40px;position: absolute;font-size:12px;color:#5f5f5f;top:-10px;"><ui:i18n key="最终效果"/></span>
							</td>
						</tr>
						<tr style="height:40px;">
							...
							<td  colspan="2" style="font-size:12px;color:#a2a2a2;">
								<input type="text" value="" id="custChanceNum" style="width:80px;margin-right:10px;"/>
					...
					<table class="game-part-table">
						...
						<tr>
							...
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg1"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money1" class="iccheckbox" data-item="1"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point1"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money1" class="iccheckbox" data-item="1"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao1"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt1"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">2</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg2"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money2" class="iccheckbox" data-item="2"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point2"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money2" class="iccheckbox" data-item="2"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao2"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt2"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">3</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg3"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money3" class="iccheckbox" data-item="3"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point3"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money3" class="iccheckbox" data-item="3"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao3"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt3"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">4</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg4"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money4" class="iccheckbox" data-item="4"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point4"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money4" class="iccheckbox" data-item="4"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao4"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt4"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">5</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg5"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money5" class="iccheckbox" data-item="5"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point5"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money5" class="iccheckbox" data-item="5"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao5"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt5"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">6</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg6"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money6" class="iccheckbox" data-item="6"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point6"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money6" class="iccheckbox" data-item="6"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao6"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt6"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">7</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg7"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money7" class="iccheckbox" data-item="7"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point7"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money7" class="iccheckbox" data-item="7"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao7"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt7"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">8</td>
							<td><input style="font-size:12px;" type="text" value="" class="msg-input msg8"/></td>
							<td style="text-align: right;">
								<input type="radio" value="1" name="send-money8" class="iccheckbox" data-item="8"/> 
								<input style="font-size:12px;"  disabled="disabled" type="text" value="" class="point-input send-point8"/>
							</td>
							<td style="text-align: right;">
								<input type="radio" value="2" name="send-money8" class="iccheckbox " data-item="8"/> 
								<input style="font-size:12px;" disabled="disabled" type="text" value="" class="point-input send-hongBao8"/>
							</td>
							<td  style="text-align: center;">
								<input style="font-size:12px;"  type="text" value="" class="send-limit cnt8"/>
							</td>
						</tr>
					</table>
			</div>
