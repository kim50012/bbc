...
$(function() {
	...
	$('.btn-step-confirm').click(function(){
		...
		if($(this).data('item') == '1'){
			...
			$.ajax({
				data : param,
				url  :  '/admin/voucher/save.htm', //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
											...
											<div class="app-design clearfix" >
												<div class="app-preview" style="margin-left: -5%;left:60px;border-radius:47px;">
										    		<div class="app-header"></div>
										   			<div class="app-entry" style="height:370px;background-color: #ffffff;border-radius:4px;">
										   				<div class="phoneImg"></div>
										   				<input type="hidden" value="" id="fileId"/>
										   				<div class="p-couponNm"></div>
										   				<div class="p-faceValue"></div>
										   				...
										   				<div class="p-buyAmount">
										   					...
										   					<span style="font-size:16px" id="allMoney"></span>
										   					<span style="font-size:16px"><ui:i18n key="元"/></span>
										   					<span><ui:i18n key="减"/></span>
										   					<span style="font-size:16px" id="moveMoney"></span>
										   					<span style="font-size:16px"><ui:i18n key="元"/></span>
										   					<span>（<ui:i18n key="含物流费"/>）</span>
										   				</div>
										   				<div class="lamitDate">
										   					<span><ui:i18n key="有效期限"/>：</span>
										   					<span id="p-startDate"></span>
										   					<span>~</span>
										   					<span id="p-endDate"></span>
										   				</div>
										   			</div>
															...
															<form class="form-horizontal" novalidate="">
																<div class="control-group" id="appendChildGroup" style="width: 480px;margin-left: 5%;margin-top:10px;">										
																	<div class="div-img-warp" style="height: 120px">
																		...
																		<div style="margin-bottom: 20px;margin-right: 5%;margin-left: 15%"><ui:i18n key="示例"/>：</div>
																	...
																	<table class="contant">
																		<tr>
																			...
																			<td colspan="2" style="width: 300px">
																				<input type="text" id="couponNm" style="width:210px;"  maxlength="10" placeholder='<ui:i18n key="最多可输入10个字"/>'/>
																			</td>
																		</tr>
																		<tr>
																			<td style="width: 100px"><ui:i18n key="优惠券金额"/><span class="bitian">*</span>：</td>
																			<td style="width:100px">
																				<input type="text" id="faceValue" style="width:130px;"  maxlength="3" placeholder='<ui:i18n key="最多可输入三位数"/>'/>
																			</td>
																			<td style="width: 200px">&nbsp;&nbsp;<ui:i18n key="元"/></td>
																		</tr>
																		<tr>
																			<td style="width: 100px"><ui:i18n key="发行数量"/><span class="bitian">*</span>：</td>
																			<td style="width: 100px"><input type="text" id="circulationCnt"  style="width:130px;"  maxlength="5" placeholder='<ui:i18n key="最多可输入五位数"/>'/></td>
																	...
																	<table class="contant">
																		<tr>
																			...
																			<td style="width: 300px" colspan="2">
																				<input type="text" class="startDate" style="width: 115px" id="startDate"  placeholder='<ui:i18n key="请选择起始日期"/>'/>
																				<span  class="bitian">~</span>
																				<input type="text" class="endDate" style="width: 115px" id="endDate" placeholder='<ui:i18n key="请选择结束日期"/>'/>
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td style="width: 100px"><input type="text"  style="width:130px;" id="buyAmount"  maxlength="5" placeholder='<ui:i18n key="最多可输入五位数"/>'/></td>
