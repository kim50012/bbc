...
{{
		...
		ids = ids.substring(0,ids.length-1);
			...
			<td><input type="text" name="sku_price" class="js-price"	 data-id="{{=ids}}" data-type="price" data-name="${label.原价}" value=""  style="width: 50px;text-align:center;" ></td>
			<td><input type="text" name="sku_price" class="js-unit"	 	 data-id="{{=ids}}" data-type="unit" data-name="${label.单价}" value=""  style="width: 50px;text-align:center;" ></td>
			<td><input type="text" name="stock_num" class="js-stock-num" data-id="{{=ids}}" data-type="stock" data-name="${label.库存}" value=""  style="width: 50px;text-align:center;" ></td>  
		</tr>
{{ 
	}  
}}
	...
	--%>	 			
				<div class="control-group">
					...
					<div class="controls">
						...
						<br />
						<span style="color:red;">(${label.主题}1 : 320px * 370px) 或 (${label.主题}2 : 320px * 250px)</span>
					</div>
				</div> 
...
<script id="tpl_sidebar_05" type="text/html">
	...
	<div class="app-sidebar-inner js-sidebar-region">
		<div>
			<form class="form-horizontal" novalidate="">
				<div class="control-group">
					<label class="control-label">${label.商品来源}：</label>
					<div class="controls">
