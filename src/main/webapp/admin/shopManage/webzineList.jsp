...
<script type="text/javascript">
	...
	function query(pageNo, pageSize){
		...
		var url = '/admin/shopManage/webzineListFragment.htm';
	...
	function addWebZineActivity(){
		window.location.href = '/admin/shopManage/addWebzineList.htm';
	}
	//修改摇奖活动
	function modifyWebZine(pageId){
		window.location.href = '/admin/shopManage/updateWebzineList.htm?pageId=' + pageId ;
	}
