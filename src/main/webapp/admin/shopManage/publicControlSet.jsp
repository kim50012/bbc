...
<script type="text/javascript">
	$(function(){
		...
		$('.index-before-img').click(function(){
			...
			$.ajax({
				data : param,
				url : '/admin/shopManage/updatePublicControlSet.htm', //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
	...
	function query(pageNo, pageSize){
		...
		var url = '/admin/shopManage/publicControlSetListFragment.htm';
	...
	function addPublicActivity(){
		window.location.href = '/admin/shopManage/addPublicControlSet.htm';
	}
	//修改摇奖活动
	function modifyPublic(pageId){
		window.location.href = '/admin/shopManage/publicControlUpdate.htm?pageId=' + pageId ;
	}
