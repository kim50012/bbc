...
$(function() {
	...
	$('.btn-step').click(function(){
		if($(this).find('span').text() == '<ui:i18n key="保存"/>'){
			...
			$.ajax({
				data:param,
				url : '/admin/shopManage/updateSaveWebzine.htm', //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
				success : function(data){
					if(data.result == 'success'){
						alert('<ui:i18n key="保存成功"/>');
						window.location.href = '/admin/shopManage/webzineList.htm';
					}else{
																		...
																		<ul class="js-img-area">
																			<li class="sort" data-goods-id="9824420540"> 
																				<div class="div-img-warp">
																					...
																					<div class="div-img-link">
																						URL：<br><input type="text" class="js-link" style="width:230px;" readonly="readonly" value="${pageDt.VAL02 }">
																						<span class="btn-span js-url-input" style="margin-left:2px;margin-right:2px;"><ui:i18n key="手输"/></span>
																						<span class="btn-span js-url-select"><ui:i18n key="选择"/></span>
																					</div>
																				</div>
																			</li>
