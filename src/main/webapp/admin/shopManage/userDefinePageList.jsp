...
/* function fn_GetData(newFlag) {
	...
	if (newFlag) {
	 ...
	 $.ajax({
			...
			type : "POST",
			url : "/admin/shopManage/getUserDefinePageList.htm",
...
// 				window.location.href = '/admin/shopManage/userDefinePageList.htm';
			},
			error : function(xhr, status, e) {
...
function query(pageNo, pageSize){
	...
	var url = '/admin/shopManage/userDefinePageFragment.htm';
			  	...
			  	<div class="result-grid" style="margin-top: 50px;">
				      	<div class="result-grid-header">
			   				<div class="result-grid-tools">
			   				   <span class="result-grid-tool" onclick="window.location='/admin/shopManage/addUserDefinePageEditor.htm'">
		...
		{{each data}}
			 <tr>	
				...
				<td class="js-grid-gexing-nm">
					...
					<span class="gridbutton red"  onclick="window.location='/admin/shopManage/modifyUserDefinePageEditor.htm?pageId={{$value.PAGE_ID}}';"><ui:i18n key="编辑"/></span>
