	...
	$('.btn-step').click(function(){
		if($(this).find('span').text() == '<ui:i18n key="保存"/>'){
			...
			/* if(typeof(positionType) == 'undefined'){
				positionType = $('.submit-modify.down-no').attr('data-position');
			}  */
			...
			$.ajax({
				data:param,
				url : '/admin/shopManage/savePublicControlSet.htm', //调用AdminGoodsSellAction中updateGoodsGroup方法进行商品分类的修改。
				success : function(data){
					if(data.result == 'success'){
						alert('<ui:i18n key="保存成功"/>');
						window.location.href = '/admin/shopManage/publicControlSet.htm';
					}else{
										    		...
										    		<div class="app-header"></div>
										        		...
										        		<div class="app-config">
										            		<div id="app-field-header" class="app-field-addImg" style="cursor: default;" >
												                ...
												                <div class="sliderImg" style="height:350px;display: none;">
														...
														<div>
															<form class="form-horizontal" novalidate="">
																...
																<div class="modify-down">
																	...
																	<!-- <div class="submit-modify up-no" data-position='TOP'> -->
																	<input type="radio" class="icradio" checked="checked" style="margin-left:20px;margin-right:5px;" name="position" value="TOP"/><ui:i18n key="向上"/>
																	<!-- <div class="submit-modify down" data-position='BOTTOM'> -->
																	<input type="radio" class="icradio"  style="margin-left:20px;margin-right:5px;" name="position" value="BOTTOM"/><ui:i18n key="向下"/>
																</div>
															</form>
														</div>
													</div>
