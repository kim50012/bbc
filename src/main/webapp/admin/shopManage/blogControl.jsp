...
function fn_MainPage_Delete(blogId) {
	if(confirm('<ui:i18n key="您确定要删除吗"/>?')) {
	 	$.ajax({
			...
			url : '/admin/shopManage/deleteShopBlog.htm',
			success : function(data) {
...
// 				window.location.href = '/admin/shopManage/blogControl.htm?blogTitle=' + blogTitle;
			},
...
function query(pageNo, pageSize){
	...
	var url = '/admin/shopManage/blogControlFragment.htm';
