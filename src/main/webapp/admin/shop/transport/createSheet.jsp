...
<title><ui:i18n key="新建运费模板"/></title>  
...
function loadGridData(type, areaParentId){
	var params = {
			type : type
			,areaParentId : areaParentId
	}
	var url = '/admin/shop/transport/areaList.htm';
			...
			<div class="form-warp clearfix">
		  			 <div class="control-warp"  >
		  			 	 ...
		  			 	 <div class="form-control">
		  			 	 	<input type="text" id="transSheetName"  placeholder="<ui:i18n key="请输入运费模板名称"/>" class="w36"  >
		  			 	 </div>
		  			 </div>
		  			 <div class="control-warp"  >
		  			 	 <div class="form-label"  >
		  			 	 ...
		  			 	 <div class="form-control">
		  			 	 	...
		  			 	 	<select id="fromCity" data-placeholder="<ui:i18n key="请选择城市"/>" class="select2 sw15"  disabled="disabled" style="margin-left: 10px;">
								<option value=""></option>
							</select>
		  			 ...
		  			 <div class="control-warp"  >
		  			 	 ...
		  			 	 <div class="form-control">
								...
								<option value=""></option>
								<option value="1"><ui:i18n key="快递"/></option>
								<option value="2">EMS</option>
								<option value="3"><ui:i18n key="平邮"/></option>
								<option value="4"><ui:i18n key="自提"/></option>
							</select>
		  			 ...
		  			 <div class="control-warp"  >
		  			 	 ...
		  			 	 <div class="form-control">
		  			 	 	<input class="icradio js-to-province" type="radio" name="areaValue" value="0" checked="checked"  />&nbsp;&nbsp;<ui:i18n key="省"/>
	     		 			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	     		 			 <input class="icradio js-to-city" type="radio" name="areaValue" value="1" />&nbsp;<ui:i18n key="市"/>
	     		 			 <select id="toProvince" data-placeholder="<ui:i18n key="请选择省份"/>" class="select2 sw15" style="margin-left: 30px;" disabled="disabled"  >
								<option value=""></option>
								 <c:forEach items="${provinceList}" var="item">
									<option value="${item.AREAID}">${item.AREANAME}</option>
								</c:forEach>
