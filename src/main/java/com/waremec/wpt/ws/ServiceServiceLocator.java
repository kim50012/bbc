...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements com.waremec.wpt.ws.ServiceService {
    ...
    private java.lang.String ServicePort_address = "https://www.hanzhimeng.com/wptws/services/ssoService";
    ...
    public com.waremec.wpt.ws.Service getServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.waremec.wpt.ws.Service getServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.waremec.wpt.ws.ServiceServiceSoapBindingStub _stub = new com.waremec.wpt.ws.ServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.waremec.wpt.ws.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                com.waremec.wpt.ws.ServiceServiceSoapBindingStub _stub = new com.waremec.wpt.ws.ServiceServiceSoapBindingStub(new java.net.URL(ServicePort_address), this);
                _stub.setPortName(getServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.wpt.waremec.com/", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.wpt.waremec.com/", "ServicePort"));
        }
