...
public class SessionSkin implements java.io.Serializable {
	...
	public String toString() {
		return "SessionSkin [shopId=" + shopId + ", skinTypeShop=" + skinTypeShop + ", skinTypeWeb=" + skinTypeWeb + ", pageIdShopMain=" + pageIdShopMain
				+ ", pageIdShopList=" + pageIdShopList + ", pageIdShopDetail=" + pageIdShopDetail + ", pageIdShopHome=" + pageIdShopHome + ", shopLogoImgUrl="
				+ shopLogoImgUrl + ", shopName=" + shopName + ", shopQRImgUrl=" + shopQRImgUrl + ", shopWechatId=" + shopWechatId + "]";
	}
