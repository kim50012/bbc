...
/** 
 * @Package com.waremec.wpt.front.event.action 
 * @FileName Event00038Action
 * @Description  
 * @author taebem 
 * @date 2015年5月26日 下午4:42:13 
 *  
 */
@Controller("event00038Action")
@Scope(ScopeType.prototype)
public class Event00038Action extends EventBaseAction {
	...
	public boolean isClosed(){
		...
		try {
			...
			Date deadline = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2017-02-14 23:59:59");
