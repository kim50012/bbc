 ...
 *  
 */
@Controller("event00019Action")
@Scope(ScopeType.prototype)
public class Event00019Action extends EventBaseAction {
	...
	public String index() {
		...
		try {
			...
			List<Map<String, Object>> prizeCnt = eventService.selectList("Event.SHOP_EVENT_USER_SELECT",parmsMap);
