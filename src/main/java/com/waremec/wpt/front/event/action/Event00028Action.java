...
/** 
 * @Package com.waremec.wpt.front.event.action 
 * @FileName Event00028Action
 * @Description  
 * @author dikim 
 * @date 2016年8月15日 上午10:14:45 
 *  
 */
@Controller("event00028Action")
@Scope(ScopeType.prototype)
public class Event00028Action extends EventBaseAction {
	...
	public String gameStart() {
		...
		eventService.selectList("Event.SHOP_EVENT_FOLLOW_ACTION_CHANCE_UPDATE",parmsMap);
	...
	public String gameResult() {
		...
		List<Map<String, Object>> list= eventService.selectList("Event.SHOP_EVENT_FOLLOW_ACTION_CHANCE_UPDATE", parmsMap);
		renderJSON(list);
