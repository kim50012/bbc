/**   
* @Title: Event00015Action.java 
* @Package com.waremec.wpt.front.event.action 
* @Description:  
* @author taebem
* @date 2015年9月11日 下午1:04:37 
* @version V1.0   
*/
package com.waremec.wpt.front.event.action;
...
/** 
 * @Package com.waremec.wpt.front.event.action 
 * @FileName Event00015Action
 * @Description  
 * @author taebem 
 * @date 2015年9月11日 下午1:04:37 
 *  
 */
@Controller("event00015Action")
@Scope(ScopeType.prototype)
public class Event00015Action extends EventBaseAction {
	...
	/*	if(5 > 1){
		...
		*/
		...
		if(StringUtils.isBlank(fromOpenid)){
			...
			Map<String, Object> resultMap = eventService.select("Event.EVENT_00015_POINT_CHECK",parmsMap);
		...
		if(StringUtils.isNotEmpty(getFromOpenid())){
			...
			Map<String, Object> userSummary = eventService.select("Event.EVENT_00015_POINT_GET_SUM",parmsMap);
			...
			parmsMap.put("EVENT_ID", eventId);
			parmsMap.put("OPENID", getFromOpenid());
			List<Map<String, Object>> friendsList = eventService.selectList("Event.EVENT_00015_POINT_FRIENDS_LIST",parmsMap);
			...
			Map<String, Object> checkItem = eventService.select("Event.EVENT_00015_POINT_CHECK",parmsMap);
	...
	public String participated() {
		...
		if(StringUtils.isBlank(fromOpenid)){
			...
			eventService.select("Event.EVENT_00015_POINT_INSERT",parmsMap);
...
//			  , OBTAIN_CNT = (SELECT COUNT(*) FROM EVENT_00015_4500)
//			  ,  SELF_CNT = (SELECT COUNT(*) FROM EVENT_00015_4500 WHERE OPENID = @FROM_OPENID)
//		
		...
		if(selfCnt > 0){
			...
			String msg4500 = "<div class='result4500' ><img alt='' src='/front/event/00015/images/participated/img_congratulation.png'  ></div> "
					+"<div class='result4500Close'  ><img alt=''  onclick='closeResult()'  src='/front/event/00015/images/participated/btn_4500_close.png'  ></div>";
...
//		Map<String, Object> resultMap = eventService.select("Event.EVENT_00015_POINT_INSERT",parmsMap);
		eventService.select("Event.EVENT_00015_POINT_INSERT",parmsMap);
