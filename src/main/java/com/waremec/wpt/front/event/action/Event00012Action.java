 ...
 *  
 */
@Controller("event00012Action")
@Scope(ScopeType.prototype)
public class Event00012Action extends EventBaseAction {
	...
	public String index() {
		...
		try {
			...
			e.printStackTrace();
			logger.error("Event00012Action.index!!!!" + e.getMessage());
		}
