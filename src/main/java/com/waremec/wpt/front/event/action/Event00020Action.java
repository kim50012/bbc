 ...
 *  
 */
@Controller("event00020Action")
@Scope(ScopeType.prototype)
public class Event00020Action extends EventBaseAction {
	...
	public String soloAction(){
		...
		String bloodtp = getRequest().getParameter("bloodtp");
		Integer eveId = getId();
		...
		siteCounting(eveId, sessionSkin.getShopId(), getSessionOpenid(), bloodtp, "BLOODTP");
		//---------------------------------------------------------------
