...
public class BbcAction extends WeixinBaseAction{
	...
	try {
	    ...
	    List<BbcAtrClbBbd> atrClbBbdList = bbcService.selectBbcAtrClbBbd("Bbc.sqlATR_CLB_BBD_SELECT", searchMap);
	...
	try {
	    ...
	    BbcAtrClbBbd atrClbBbdList = bbcService.selectBbcAtrClbBbdOne("Bbc.sqlATR_CLB_BBD_SELECT", searchMap);
	    request.put("atrClbBbdList", atrClbBbdList);
	} catch (Exception e) {
	    // Error Page
	    String errorMessageBbc = e.getMessage();
