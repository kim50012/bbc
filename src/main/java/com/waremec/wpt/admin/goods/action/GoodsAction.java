...
@Controller("adminGoodsAction")
@Scope(ScopeType.prototype)
public class GoodsAction extends BaseAction implements ServletContextAware {
	...
	public String goodsCreate() {
		...
		Map<String, Object> parmsMap = new HashMap<String, Object>();
		parmsMap.put("SHOP_ID", getBackSessionShopId());
		List<Map<String, Object>> brandList = commonService.selectList("AdminGoods.getBrandList", parmsMap);
...
//				, @PAGE_ID 					INT				= NULL	-- Dynamic Page ID
	 ...
	 * @throws Exception
	 */
	public String displayPreview() throws Exception {
...
//				goodsDisplayService.createGoodsDisplay(pmap);
	...
	public String addShopGoodsClass() throws Exception{
	...
	public String getGoodsLevel1() throws Exception {
...
//		ListUtil.printListMap(commonService.selectList("AdminGoods.selectGoodsClassCombo" , paramsMap));
