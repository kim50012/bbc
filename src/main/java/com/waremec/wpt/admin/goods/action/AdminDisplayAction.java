 ...
 *  
 */
@Controller("adminDisplayAction")
@Scope(ScopeType.prototype)
public class AdminDisplayAction extends BaseAction{
	...
	public String normalList() {	
		...
		//int pageUnitCount=goodsSellService.selectCount("GoodsDisplay.selectGoodsCount",adminGoodsDisplay);
		int pageCount=0;
	...
	public String normalListFragment() {	
		userId=getBackSessionUserId();
		shopId = getBackSessionShopId();
		Map<String,Object> goodsMap=new HashMap<String, Object>();
		goodsMap.put("SHOP_ID", shopId);//Integer.valueOf(shopId)
	...
	public String updateDisplayGoodsPosition(){
		userId=getBackSessionUserId();
		shopId = getBackSessionShopId();
		String ret="success";
		try{
