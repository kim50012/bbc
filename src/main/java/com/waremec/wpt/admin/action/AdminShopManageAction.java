...
@Controller("adminShopManageAction")
@Scope(ScopeType.prototype)
public class AdminShopManageAction extends BaseAction {
	...
	public String webzineListFragment() {
		String serachTitle = getRequest().getParameter("goodsNm");
		serachLinkType = "5";
		if(serachTitle==null || serachTitle==""){
			serachTitle="";
	...
	//店铺主页
	public String shopMainPageList() {
		...
		return "shopMainPageList";
	}
	//店铺主页分页
	public String shopMainPageFragment() {
		String serachLinkType = "6";
	...
	public String addWebzineList(){
		return "addWebzineList";
	}
	...
	public String blogControl(){
		...
		request.put("groupList", commonService.selectList(
				"Blog.selectShopBlogList", paramsMap));
		request.put("blogGroupId", blogGroupId);
		return "blogControl";
	}
	//日志管理分页
	public String blogControlFragment(){
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("shopId",getBackSessionShopId());
		map.put("blogGroupId", StringUtil.emptyToNull(blogGroupId));
		map.put("pageCurr", pageCurr);
	...
	//保存修改微杂志、页面
	public String updateSaveWebzine(){
		String ret="success";
		Map<String, Object> parmsMap = new HashMap<String, Object>();
		parmsMap.put("SHOP_ID", getBackSessionShopId().toString());
		parmsMap.put("USER_ID", getBackSessionUserId().toString());
	...
	//打开修改微杂志、页面名字
	public String updateWebzineList(){
		Integer displayId=null;
		Integer pageId = IntegerUtils.valueOf(getRequest().getParameter("pageId"));
		Map<String,Object> paramsMap = new HashMap<String,Object>();
		paramsMap.put("SHOP_ID", getBackSessionShopId());
...
//		ListUtil.printListMap(shopMainPageData);
	...
	public String addCustomPageEditor() {
		...
		return "addCustomPageEditor";
	}

public String modifyCustomPageEditor() {
	...
	public String deleteDynamicPage(){
		...
		List<Map<String, Object>> list = commonService.selectList("Template.deletePageHeader",parmsMap);
	...
	public String updateShopMainPageUse() {
		
		Map<String, Object> parmsMap = new HashMap<String, Object>();
		parmsMap.put("shopId", getBackSessionShopId());
		parmsMap.put("pageId", pageId);
		parmsMap.put("createdId", getBackSessionUserId());
		parmsMap.put("jobType",jobType);
		
		List<Map<String, Object>> list = commonService.selectList("Template.updatePageShop",parmsMap);
	...
	public String saveShopNavigation() {
		String ret = "success";
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("SHOP_ID", getBackSessionShopId());
