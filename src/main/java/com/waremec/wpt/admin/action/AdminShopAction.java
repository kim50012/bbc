...
public class AdminShopAction extends BaseAction implements ServletContextAware {
	 ...
	 * @return
	 */
	public String updateShopBaseMessage() {
		userId = getBackSessionUserId();
		// shopId = session.get(SessionUtils.SHOP_ID_SESSION).toString();
		// 判断信息，判断操作是否成功。
		String ret = "SUCCESS";
