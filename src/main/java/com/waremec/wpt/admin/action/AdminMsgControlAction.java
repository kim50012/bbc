...
@Controller("adminMsgControlAction")
@Scope(ScopeType.prototype)
public class AdminMsgControlAction extends BaseAction {
	...
	//打开该信息管理的预览信息
	public String msgControlPreviewWeixin(){
		shopId=getBackSessionShopId().toString();
		userId=getBackSessionUserId();
		Map<String,Object> map=new HashMap<String,Object>(); 
		map.put("shopId", shopId);
		...
		renderJSON(returnMap);*/
		request.put("list", list);
		return "msgControlPreviewWeixin";
	}
	//打开新建图文消息页面
