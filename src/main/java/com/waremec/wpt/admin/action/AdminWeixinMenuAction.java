...
@Controller("adminWeixinMenuAction")
@Scope(ScopeType.prototype)
public class AdminWeixinMenuAction extends BaseAction {
...
//
//			AdminWxCustMenu wxCustMenuIn = new AdminWxCustMenu();
//			wxCustMenuIn.setSHOP_ID_IN(Integer.parseInt(SHOP_ID));
//			if(!MENU_ID2.equals("")){
//				wxCustMenuIn.setMENU_ID_IN(Integer.parseInt(MENU_ID2));
//			} else {
//				wxCustMenuIn.setMENU_ID_IN(Integer.parseInt(MENU_ID));
//			}
//			wxCustMenuIn.setOPTION_TYPE_IN(OPTION_TYPE);
//			wxCustMenuIn.setUSER_ID_IN(USER_ID);
//			
//			wxCustMenuService.insertDomain("AdminWxCustMenu.delete", wxCustMenuIn);
//			
//		}catch(Exception e) {
//			ret = "FAIL";
//		}
	...
	public String publish() {
		...
		try {
			...
			//for (int i = 0; i < strMenuIds.length; i++) {
				...
				AdminWxCustMenu wxCustMenuIn = new AdminWxCustMenu();
				wxCustMenuIn.setSHOP_ID_IN(getBackSessionShopId());
				//wxCustMenuIn.setMENU_ID_IN(Integer.parseInt(strMenuIds[i]));
				//wxCustMenuIn.setMENU_ID_IN(Integer.parseInt("0"));
				wxCustMenuIn.setUSER_ID_IN(getBackSessionUserId());
