...
@Controller("adminBkblAction")
@Scope(ScopeType.prototype)
public class AdminBkblAction extends BaseAction implements ServletContextAware{
	private static final long serialVersionUID = 1L;
	public static final int PMS_FILEGROUP = 4; //PMS附件标识
	public static final String PMS_SHOPID = "0";//PMS专用shopId
