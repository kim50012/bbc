...
@Controller("hzmGoodsClassAction")
@Scope(ScopeType.prototype)
public class Hzm_GoodsClassAction extends BaseAction {
	 ...
	 */
	public String hzm_ListNewPopup() {
	 ...
	 */
	public String hzm_ListModifyPopup() {
	 ...
	 */
	public String hzm_TwoSelectList() {
	 ...
	 */
	public String hzm_OneSelectCheck() {
	 ...
	 * @exception: 商品分类一修改页面第一级分类保存验证
	 */
	public String hzm_OneSelectModifyCheck2() {
	 ...
	 * @exception:	商品登记一删除
	 */
	public String hzm_AjaxGcDelete() {	
	 ...
	 * @exception:	商品登记一菜单排序
	 */
	public String hzm_AjaxMenuSort() {	
	 ...
	 * @throws Exception
	 */
	public String hzm_AddSpecLevelOne() throws Exception{
	 ...
	 * @throws Exception
	 */
	public String hzm_AddSpecLevelTwo() throws Exception{
		Map<String,Object> paramsMap = new HashMap<String,Object>();
		paramsMap.put("SHOP_ID", getBackSessionShopId());
		paramsMap.put("GC_ID", IntegerUtils.valueOf(getRequest().getParameter("gcId")));
