...
@Controller("hzmWeixinReplyAction")
@Scope(ScopeType.prototype)
public class Hzm_WeixinReplyAction extends BaseAction {
	...
	public String hzm_PreviewNewsMaterial(){
		...
		return "hzm_PreviewNewsMaterial";
	}
	...
	* @return
	*/
	public String hzm_AutoFragment() {
		shopId = getBackSessionShopId();
		userId = getBackSessionUserId();
		try {
			Map<String, Object> map = new HashMap<String, Object>();
