 ...
 * 
 */
@Controller("hzmGoodsManageAction")
@Scope(ScopeType.prototype)
public class Hzm_GoodsManageAction extends BaseAction {
	...
	// 商品下架操作
	public String hzm_UpdateDisplayGoods() {
		String ret = "success";
	 ...
	 * @return
	 */
	public String hzm_PublishGoods() {
		userId = getBackSessionUserId();
		shopId = getBackSessionShopId();
