...
@Controller("hzmBlogAction")
@Scope(ScopeType.prototype)
public class Hzm_BlogAction extends BaseAction {
	...
	public String hzm_BlogCreate() throws Exception {
	 ...
	 * @return
	 */
	public String hzm_LogTemplate() {
		int shopId = getBackSessionShopId();
		//查询所有日志模板
		Map<String, Object> queryLogMap = new HashMap<String, Object>();
		queryLogMap.put("SEARCH_TYPE", Hzm_StopPageType.BLOG_TYPE);
		List<Map<String, Object>> LogTemplateList = commonService.selectList("Blog.getLogTemplateList",queryLogMap);
		request.put("LogTemplateList", LogTemplateList);
		
		queryLogMap.clear();
		
		//查询正在使用的模板
		queryLogMap.put("SHOP_ID", shopId);
		queryLogMap.put("SET_ID", Hzm_StopPageType.BLOG_TYPE);
		List<Map<String, Object>> list = commonService.selectList("AdminGoods.SHOP_SETTING_SELECT",queryLogMap);
		
		if(!list.isEmpty()){
			request.put("logId", String.valueOf(list.get(0).get("VAL_INT")));
		}
		
		request.put("shopId", shopId);
		return "hzm_LogTemplate";
	}
	 ...
	 * @return
	 */
	public String hzm_UpdateSaveLogTemplate(){
		String ret="";
		
		//更新日志模板
		Map<String, Object> setMap = new HashMap<String, Object>();
		setMap.put("SHOP_ID", shopId);
		setMap.put("SET_ID", Hzm_StopPageType.BLOG_TYPE);
		setMap.put("VAL_INT", logTemplateId);
	 ...
	 * @return
	 */
	public String hzm_BlogClassifyManager(){
		Map<String, Object> paramsMap = new HashMap<String, Object>();
		paramsMap.put("shopId", getBackSessionShopId());
		request.put("list", commonService.selectList("Blog.selectShopBlogList", paramsMap));
		return "hzm_BlogClassifyManager";
	}
	/**
	 * 修改日志分类
	 * @return
	 */
	public String hzm_UpdateBlogClassify(){
...
//		MapUtil.printMap(resultMap);
	...
	public String hzm_GetBlogManage(){
		Map<String, Object> paramsMap = new HashMap<String, Object>();
		paramsMap.put("SHOP_ID", getBackSessionShopId());
		paramsMap.put("BG_ID", null);
		paramsMap.put("BG_PARENT_ID", null);
...
//		MapUtil.printOrderedMap(blogMaster);
	...
	public String hzm_BlogModify() throws Exception {
...
//				System.out.println(pageDtl.getTxt01());
	...
	//打开积分设定弹窗
	public  String hzm_ShowPointPoupe() {
	...
	public void setLogTemplateId(String logTemplateId) {
