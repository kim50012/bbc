...
import com.waremec.weixin.domain.mass.PreviewMassReturn;
import com.waremec.weixin.domain.mass.SendMassStatusReturn;
import com.waremec.weixin.domain.mass.Text;
import com.waremec.weixin.domain.mass.UploadImgReturn;
...
/** 
* @Package com.waremec.weixin.utils 
* @FileName WeixinMassMessageUtils
* @Description  高级群发接口工具类
* @author taebem 
* @date 2015年5月7日 下午3:57:31 
*  
*/
...
//		getSendMassStatus(token,2353205468l);
 
		logger.info(uploadImg(token,"E:/uploadimgtets/1.jpg")); //{"url":"http:\/\/mmbiz.qpic.cn\/mmbiz\/C8BPV378uViaDtegQMODowicYq74GGUCbb2xAeqbJtFdxNbhlqPJz8Npr4jHuiaIU62tBtwPlurUlBwTzBIbnTXvQ\/0"}
//		logger.info(uploadImg(token,"E:/uploadimgtets/1039.jpg")); //{"errcode":40009,"errmsg":"invalid image size"}
//		logger.info(uploadImg(token,"E:/uploadimgtets/pt.gif")); //{"errcode":40005,"errmsg":"invalid file type"}
//		logger.info(uploadImg(token,"E:/uploadimgtets/3.jpeg")); //{"errcode":40005,"errmsg":"invalid file type"}
...
//		}
	 ...
	 * 
	 * 2015年7月28日
	 * 群发接口在群发图文消息时，增加了msg_data_id的返回，可以用于在群发后使用图文分析接口获取图文消息的数据。
	 */
	...
	/**
	 * 预览接口
	 * 发者可通过该接口发送消息给指定用户，在手机端查看消息的样式和排版。
	 * @param access_token
	 * @param touser 接收消息用户对应该公众号的openid
	 * @param msgtype 群发的消息类型，图文消息为mpnews，文本消息为text，语音为voice，音乐为music，图片为image，视频为video
