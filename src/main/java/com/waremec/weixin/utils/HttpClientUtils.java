...
import com.waremec.weixin.exception.HttpClientException;
import com.waremec.weixin.exception.WeixinErrorException;

/** 
* @Package com.waremec.weixin.utils 
* @FileName HttpClientUtils
* @Description  HttpClient4工具类
* @author taebem 
* @date 2015年5月7日 下午4:02:33 
*  
*/
...
//			multipartEntity.addPart("desc", new StringBody(file.getName(), ContentType.MULTIPART_FORM_DATA));
			/***4.3之前 end**/
			/***4.3之后**/
...
//			httpClient.getConnectionManager().shutdown();
	...
	* @return
	*/
	public static String uploadVideoMaterial(String url, String type, String fileUrl, String title, String introduction) {
		String returns = "";
	     CloseableHttpClient httpClient = HttpClientBuilder.create().build();
		try {
			HttpPost httpPost = new HttpPost(url);
