...
import com.waremec.weixin.domain.IPReturn;
import com.waremec.weixin.domain.TokenInfo;
import com.waremec.weixin.exception.WeixinErrorException;
import com.waremec.weixin.servlet.utils.MyX509TrustManager;

/** 
* @Package com.waremec.weixin.utils 
* @FileName WeixinUtils
* @Description  基础接口
* @author taebem 
* @date 2015年5月25日 上午9:54:55 
*  
*/
