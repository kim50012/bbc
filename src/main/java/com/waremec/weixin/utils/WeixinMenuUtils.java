/**   
* @Title: WeixinMenuUtils.java 
* @Package com.waremec.weixin.utils 
* @Description:   自定义菜单管理工具类
* @author taebem
* @date 2015年5月21日 上午10:52:36 
* @version V1.0   
*/
package com.waremec.weixin.utils;
...
import com.waremec.weixin.domain.menu.SelfmenuInfoReturn;
import com.waremec.weixin.exception.WeixinErrorException;

/** 
 * @Package com.waremec.weixin.utils 
 * @FileName WeixinMenuUtils
 * @Description  自定义菜单管理工具类
 * @author taebem 
 * @date 2015年5月21日 上午10:52:36 
 *  
...
public class WeixinMenuUtils {
	...
	private static final transient Log logger = LogFactory.getLog(WeixinMenuUtils.class);
	...
	*/
	...
	public static void main(String[] args) {
		...
		String token = TokenUtils.getToken(24);
//		logger.info("token==" + token);
   
// 	    logger.info("****************************************");
// 		getCurrentSelfMenuInfo(token);
//		logger.info("****************************************");
 		getMenu(token);
	}
