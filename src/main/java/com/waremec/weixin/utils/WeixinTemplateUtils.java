/**   
* @Title: WeixinTemplateUtils.java 
* @Package com.waremec.weixin.utils 
* @Description:  发送消息- 模板消息接口工具类  
* @author taebem
* @date 2015年5月8日 下午3:54:25 
* @version V1.0   
*/
package com.waremec.weixin.utils;
...
import com.waremec.weixin.domain.template.GetTemplateIdReturn;
import com.waremec.weixin.domain.template.SendTemplateMessageReturn;
import com.waremec.weixin.exception.WeixinErrorException;
import com.waremec.weixin.service.WeixinService;

/** 
 * @Package com.waremec.weixin.utils 
 * @FileName WeixinTemplateUtils
 * @Description  发送消息- 模板消息接口工具类  
 * @author taebem 
 * @date 2015年5月8日 下午3:54:25 
 *  
...
public class WeixinTemplateUtils extends WeixinBaseUtils {
	private static final transient Log logger = LogFactory.getLog(WeixinTemplateUtils.class);
...
//		String openid = openidlist.get(appInfo.getSysId());
		String openid ="o1yuEt4GiffFpKO29zXDnrJGi5HU";
		logger.info("openid=" +openid);
		
		

//        订单付款成功通知  LASkhiPAnCS8l7ui_ltikiVqBnsAZlbomGc8Gcozyzg
//       购买成功通知  ZqwvflxWIJWbZee1G3TuFoiHGhk6y5wPyAgbYdX5Tew
//	客户等级变更通知 7_iFoA_J4f3-2037pWfDYHc9qJq0Vx9miKJeye8UjB8
		
//		 String  sortId = "TM00247";
//		String templateId = getTemplateId(token,sortId);
		
		String templateId = "";
		Map<String,DataItem> data = new HashMap<String,DataItem>();
		
//		logger.info("****************************************");
//		templateId = "ZqwvflxWIJWbZee1G3TuFoiHGhk6y5wPyAgbYdX5Tew"; //ZqwvflxWIJWbZee1G3TuFoiHGhk6y5wPyAgbYdX5Tew
//		logger.info("templateId=" + templateId);
//		
//	 
//		data.clear();
//		data.put("first", new DataItem("您好，订单支付成功"));
//		data.put("product", new DataItem("**薯片","#173177"));
//		data.put("price", new DataItem("4元","#173177"));
//		data.put("time", new DataItem("2015年5月10日","#173177"));
//		data.put("remark", new DataItem("祝您生活愉快！","#173177"));
//		
//		sendTemplateMessage(token, openid, templateId, "http://www.baidu.com", data);
//		
//		logger.info("****************************************");
//		
//		templateId = "LASkhiPAnCS8l7ui_ltikiVqBnsAZlbomGc8Gcozyzg";//订单付款成功通知
//		logger.info("templateId=" + templateId);
//		
//		data.clear();
//		data.put("first", new DataItem("您好，您的订单已付款成功","#173177"));
//		data.put("keyword1", new DataItem("888883888","#173177"));
//		data.put("keyword2", new DataItem("2015年5月5日 17:10","#173177"));
//		data.put("keyword3", new DataItem("88元","#173177"));
//		data.put("keyword4", new DataItem("信用卡","#173177")); 
//		data.put("remark", new DataItem("感谢您的惠顾","#173177"));
//		
//		sendTemplateMessage(token, openid, templateId, null, data);
		 
		logger.info("****************************************");
		
		templateId = "7_iFoA_J4f3-2037pWfDYHc9qJq0Vx9miKJeye8UjB8";//客户等级变更通知
		logger.info("templateId=" + templateId);
		
 		data.clear();
		data.put("first", new DataItem("恭喜，您的会员等级已升级！","#173177"));
		data.put("keyword1", new DataItem("银冠会员","#173177"));
		data.put("keyword2", new DataItem("5笔","#173177"));
		data.put("keyword3", new DataItem("1028.5元","#173177"));
		data.put("remark", new DataItem("感谢您的使用","#173177"));
