...
public class WXBizMsgCryptTest {
	...
	@Test
	public void testNormal() throws ParserConfigurationException, SAXException, IOException, DocumentException {
		try {
			...
			String msgSignature =  root.element("MsgSignature").getStringValue();
			///
			///
