...
//			System.out.println("++++>"+StringUtils.isBlank(requestMap.get("AppId")));
			if(!StringUtils.isBlank(requestMap.get("AppId"))){
				//提取密文 Appid
				encrypt = XMLParse.extractForAppId(postData);
			} else {
				//提取密文 ToUserName
...
//		System.out.println("sucddd===========" + signature);
		// 和URL中的签名比较是否相等
