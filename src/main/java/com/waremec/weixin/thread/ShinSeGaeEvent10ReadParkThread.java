/**   
* @Title: ShinSeGaeEvent10ReadParkThread.java 
* @Package com.waremec.weixin.thread 
* @Description:  
* @author taebem
* @date 2015年9月8日 下午12:19:47 
* @version V1.0   
*/
package com.waremec.weixin.thread;
...
/** 
 * @Package com.waremec.weixin.thread 
 * @FileName ShinSeGaeEvent10ReadParkThread
 * @Description  新世界-活动10 发红包
 * @author taebem 
 * @date 2015年9月8日 下午12:19:47 
 *  
 */
public class ShinSeGaeEvent10ReadParkThread implements Runnable {
	...
	public ShinSeGaeEvent10ReadParkThread(HttpServletRequest request, WeixinService weixinService, AppInfo appInfo, String openid) {
		super();
	...
	*/
	...
	public void run() {
		...
		System.out.println("=============ShinSeGaeEvent10ReadParkThread================");
