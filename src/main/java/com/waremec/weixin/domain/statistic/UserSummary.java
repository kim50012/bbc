/**   
 * @Title: UserSummary.java 
 * @Package com.waremec.weixin.domain.statistic 
 * @Description:  
 * @author taebem
 * @date 2015年6月24日 下午1:39:06 
 * @version V1.0   
 */
package com.waremec.weixin.domain.statistic;
...
/**
 * @Package com.waremec.weixin.domain.statistic
 * @FileName UserSummary
 * @Description 获取用户增减数据（getusersummary) item - response
 * @author taebem
 * @date 2015年6月24日 下午1:39:06
 * 
 */
public class UserSummary {
	...
	*/
	...
	public String toString() {
		return "UserSummary [ref_date=" + ref_date + ", user_source=" + user_source + ", new_user=" + new_user + ", cancel_user=" + cancel_user + "]";
	}
