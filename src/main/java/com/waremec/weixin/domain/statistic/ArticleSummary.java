/**   
* @Title: ArticleSummary.java 
* @Package com.waremec.weixin.domain.statistic 
* @Description:  
* @author taebem
* @date 2015年6月25日 上午11:41:20 
* @version V1.0   
*/
package com.waremec.weixin.domain.statistic;
...
/** 
 * @Package com.waremec.weixin.domain.statistic 
 * @FileName ArticleSummary
 * @Description  获取图文群发每日数据（getarticlesummary） item
 * @author taebem 
 * @date 2015年6月25日 上午11:41:20 
 *  
 */
public class ArticleSummary {
	...
	*/
	...
	public String toString() {
		return "ArticleSummary [ref_date=" + ref_date + ", user_source=" + user_source + ", msgid=" + msgid + ", title=" + title + ", int_page_read_user="
				+ int_page_read_user + ", int_page_read_count=" + int_page_read_count + ", ori_page_read_user=" + ori_page_read_user + ", ori_page_read_count="
				+ ori_page_read_count + ", share_user=" + share_user + ", share_count=" + share_count + ", add_to_fav_user=" + add_to_fav_user
