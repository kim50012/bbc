/**   
* @Title: UpstreamMsg.java 
* @Package com.waremec.weixin.domain.statistic 
* @Description:  
* @author taebem
* @date 2015年6月25日 上午8:43:15 
* @version V1.0   
*/
package com.waremec.weixin.domain.statistic;
...
/** 
 * @Package com.waremec.weixin.domain.statistic 
 * @FileName UpstreamMsg
 * @Description  消息分析数据接口 item - response
 * @author taebem 
 * @date 2015年6月25日 上午8:43:15 
 *  
 */
public class UpstreamMsg {
	...
	*/
	...
	public String toString() {
		return "UpstreamMsg [ref_date=" + ref_date + ", ref_hour=" + ref_hour + ", user_source=" + user_source + ", msg_type=" + msg_type + ", msg_user="
				+ msg_user + ", msg_count=" + msg_count + ", count_interval=" + count_interval + ", int_page_read_count=" + int_page_read_count
