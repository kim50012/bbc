...
public class UserRead {
	...
	*/
	...
	public String toString() {
		return "UserRead [ref_date=" + ref_date + ", ref_hour=" + ref_hour + ", user_source=" + user_source + ", int_page_read_user=" + int_page_read_user
				+ ", int_page_read_count=" + int_page_read_count + ", ori_page_read_user=" + ori_page_read_user + ", ori_page_read_count="
