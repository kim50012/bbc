/**   
* @Title: UserCumulate.java 
* @Package com.waremec.weixin.domain.statistic 
* @Description:  
* @author taebem
* @date 2015年6月24日 下午3:47:14 
* @version V1.0   
*/
package com.waremec.weixin.domain.statistic;
...
/** 
 * @Package com.waremec.weixin.domain.statistic 
 * @FileName UserCumulate
 * @Description  获取累计用户数据（getusercumulate） item - response
 * @author taebem 
 * @date 2015年6月24日 下午3:47:14 
 *  
 */
public class UserCumulate {
	...
	*/
	...
	public String toString() {
		return "UserCumulate [ref_date=" + ref_date + ", user_source=" + user_source + ", cumulate_user=" + cumulate_user + "]";
	}
