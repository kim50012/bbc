...
//	ThumbMediaId		是	缩略图的媒体id，通过上传多媒体文件，得到的id
	...
	public Music(String toUserName, String fromUserName, String createTime,
			String thumbMediaId) {
		super();
	...
	public String toString() {
		...
		String format 	= "<xml>\n" 											
	 	...
	 	return String.format( format,toUserName, fromUserName, createTime, title, description,musicUrl, hqMusicUrl,thumbMediaId);
	}
