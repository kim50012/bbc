 ...
 *  -----------------Response----------------------- 
	 <xml>
		 ...
		 <cash_fee><![CDATA[1002]]></cash_fee>
		 <mch_id><![CDATA[1225226202]]></mch_id>
		 <nonce_str><![CDATA[QUDswopQyUPUZhNF]]></nonce_str>
		 <out_refund_no_0><![CDATA[10125]]></out_refund_no_0>
		 <out_trade_no><![CDATA[10125]]></out_trade_no>
		 <refund_count>1</refund_count>
		 <refund_fee>1002</refund_fee>
		 <refund_fee_0>1002</refund_fee_0>
		 <refund_id_0><![CDATA[2008960276201504080002738264]]></refund_id_0>
		 <refund_status_0><![CDATA[PROCESSING]]></refund_status_0>
		 <result_code><![CDATA[SUCCESS]]></result_code>
		 <return_code><![CDATA[SUCCESS]]></return_code>
		 <return_msg><![CDATA[OK]]></return_msg>
		 <sign><![CDATA[1CD66D1644AC51CC3BD0C6F1801C8C02]]></sign>
		 <total_fee><![CDATA[1002]]></total_fee>
		 <transaction_id><![CDATA[1008960276201504080052050152]]></transaction_id>
	 </xml> -----------------Response-----------------------
 *
 */
public class PayRefundQueryResponse {
	...
	public String toString() {
		return "PayRefundQueryResponse [return_code=" + return_code + ", return_msg=" + return_msg + ", result_code=" + result_code + ", err_code=" + err_code
				+ ", err_code_des=" + err_code_des + ", appid=" + appid + ", mch_id=" + mch_id + ", device_info=" + device_info + ", nonce_str=" + nonce_str
				+ ", sign=" + sign + ", transaction_id=" + transaction_id + ", out_trade_no=" + out_trade_no + ", total_fee=" + total_fee + ", fee_type="
				+ fee_type + ", cash_fee=" + cash_fee + ", cash_fee_type=" + cash_fee_type + ", refund_fee=" + refund_fee + ", coupon_refund_fee="
				+ coupon_refund_fee + ", refund_count=" + refund_count + ", out_refund_no_0=" + out_refund_no_0 + ", refund_id_0=" + refund_id_0
				+ ", refund_status_0=" + refund_status_0 + ", refund_channel_0=" + refund_channel_0 + ", refund_fee_0=" + refund_fee_0 + ", fee_type_0="
				+ fee_type_0 + ", out_refund_no_1=" + out_refund_no_1 + ", refund_id_1=" + refund_id_1 + ", refund_status_1=" + refund_status_1
				+ ", refund_channel_1=" + refund_channel_1 + ", refund_fee_1=" + refund_fee_1 + ", fee_type_1=" + fee_type_1 + "]";
	}
