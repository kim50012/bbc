...
public class WeixinOrderInfo {
	...
	public String toString() {
		return "WeixinOrderInfo [orderId=" + orderId + ", custOrderId=" + custOrderId + ", out_trade_no=" + out_trade_no + ", transaction_id=" + transaction_id
				+ ", body=" + body + ", detail=" + detail + ", total_fee=" + total_fee + ", total_fee2=" + total_fee2 + ", shopNm=" + shopNm
				+ ", out_refund_no=" + out_refund_no + ", refund_id=" + refund_id + ", refund_fee=" + refund_fee + ", statusId=" + statusId + ", isRefundReq="
				+ isRefundReq + "]";
	}
